...
/*     */   
/*  53 */   public FastClassEmitter(ClassVisitor v, String className, Class type) { super(v);
/*     */     
...
/*  69 */     CollectionUtils.filter(methods, new org.springframework.cglib.core.DuplicatesPredicate());
/*  70 */     List constructors = new ArrayList(java.util.Arrays.asList(type.getDeclaredConstructors()));
...
/* 114 */     List signatures = CollectionUtils.transform(methods, new org.springframework.cglib.core.Transformer() {
...
/*     */     {
/* 130 */       List signatures = CollectionUtils.transform(methods, new org.springframework.cglib.core.Transformer() {
/*     */         public Object transform(Object obj) {
...
/*     */       }
/*     */       
/* 155 */       public void processDefault() { e.push(-1);
/* 156 */         e.return_value();
/*     */       }
/* 158 */     };
/* 159 */     EmitUtils.string_switch(e, 
/* 160 */       (String[])signatures.toArray(new String[signatures.size()]), 1, callback);
/*     */   }
/*     */   
/*     */ 
...
/* 169 */     e.process_switch(getIntRange(info.size()), new org.springframework.cglib.core.ProcessSwitchCallback() {
/*     */       public void processCase(int key, Label end) {
/* 171 */         MethodInfo method = (MethodInfo)this.val$info.get(key);
...
/*     */       }
/*     */       
/* 187 */       public void processDefault() { e.goTo(illegalArg);
/*     */       }
/* 189 */     });
/* 190 */     block.end();
...
/* 198 */     private Map indexes = new java.util.HashMap();
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\reflect\FastClassEmitter.class
