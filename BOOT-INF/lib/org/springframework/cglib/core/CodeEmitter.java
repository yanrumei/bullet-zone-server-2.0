...
/* 170 */     switch (mode) {
/* 171 */     case 156:  jumpmode = 155; break;
/* 172 */     case 158:  jumpmode = 157;
/*     */     }
...
/*     */   
/*     */ 
/* 240 */   public void monitorenter() { this.mv.visitInsn(194); }
/* 241 */   public void monitorexit() { this.mv.visitInsn(195); }
/*     */   
/* 243 */   public void math(int op, Type type) { this.mv.visitInsn(type.getOpcode(op)); }
/*     */   
...
/* 502 */       .getName(), sig
/* 503 */       .getDescriptor(), ((!sig.getName().equals("<init>")) || (opcode == 182) || (opcode != 184)) || (opcode == 185));
/*     */   }
/*     */   
...
/*     */   
/*     */ 
/* 544 */   public void new_instance(Type type) { emit_type(187, type); }
/*     */   
...
/* 563 */   public void aastore() { this.mv.visitInsn(83); }
/* 564 */   public void athrow() { this.mv.visitInsn(191); }
/*     */   
...
/*     */   
/*     */ 
/* 593 */   public void instance_of_this() { instance_of(this.ce.getClassType()); }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\core\CodeEmitter.class
