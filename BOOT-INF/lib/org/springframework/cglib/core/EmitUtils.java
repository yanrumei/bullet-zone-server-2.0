...
/* 194 */     Map buckets = CollectionUtils.bucket(Arrays.asList(strings), new Transformer() {
...
/* 203 */         List bucket = (List)this.val$buckets.get(new Integer(key));
/* 204 */         EmitUtils.stringSwitchHelper(e, bucket, callback, def, end, 0);
/*     */       }
/*     */       
/* 207 */       public void processDefault() { e.goTo(def);
/*     */       }
/* 209 */     });
/* 210 */     e.mark(def);
/* 211 */     e.pop();
...
/* 223 */     Map buckets = CollectionUtils.bucket(strings, new Transformer() {
/*     */       public Object transform(Object value) {
/* 225 */         return new Integer(((String)value).charAt(this.val$index));
/*     */       }
/* 227 */     });
/* 228 */     e.dup();
/* 229 */     e.push(index);
...
/*     */       public void processCase(int key, Label ignore_end) throws Exception {
/* 233 */         List bucket = (List)this.val$buckets.get(new Integer(key));
/* 234 */         if (index + 1 == len) {
/* 235 */           e.pop();
...
/*     */       }
/*     */       
/* 242 */       public void processDefault() { e.goTo(def); }
/*     */     });
/*     */   }
/*     */   
...
/*     */     throws Exception
/*     */   {
/* 261 */     Map buckets = CollectionUtils.bucket(Arrays.asList(strings), new Transformer() {
/*     */       public Object transform(Object value) {
...
/*     */       public void processCase(int key, Label ignore_end) throws Exception {
/* 272 */         List bucket = (List)this.val$buckets.get(new Integer(key));
/* 273 */         Label next = null;
/* 274 */         Iterator it; if ((skipEquals) && (bucket.size() == 1)) {
/* 275 */           if (skipEquals)
/* 276 */             e.pop();
/* 277 */           callback.processCase((String)bucket.get(0), end);
/*     */         } else {
/* 279 */           for (it = bucket.iterator(); it.hasNext();) {
/* 280 */             String string = (String)it.next();
/* 281 */             if (next != null) {
/* 282 */               e.mark(next);
/*     */             }
/* 284 */             if (it.hasNext()) {
...
/*     */       }
/*     */       
/* 300 */       public void processDefault() { e.pop();
/*     */       }
/* 302 */     });
/* 303 */     e.mark(def);
...
/* 423 */         EmitUtils.hash_code(this.val$e, type, multiplier, registry);
/*     */       }
/* 425 */     });
/* 426 */     e.goTo(end);
/* 427 */     e.mark(skip);
...
/*     */   {
/* 511 */     new ProcessArrayCallback()
/*     */     {
/* 509 */       public void processElement(Type type) { EmitUtils.not_equals_helper(this.val$e, type, notEquals, registry, this); } }
/*     */     
...
/*     */       public void processElement(Type type) {
/* 613 */         EmitUtils.append_string_helper(this.val$e, type, d, registry, this);
/* 614 */         this.val$e.push(d.inside);
/* 615 */         this.val$e.invoke_virtual(Constants.TYPE_STRING_BUFFER, EmitUtils.APPEND_STRING);
/*     */       }
/* 617 */     };
...
/*     */     
/* 698 */     public ArrayDelimiters(String before, String inside, String after) { this.before = before;
...
/*     */     try
/*     */     {
/* 732 */       Map cache = new HashMap();
/* 733 */       final ParameterTyper cached = new ParameterTyper() {
/*     */         public Type[] getParameterTypes(MethodInfo member) {
/* 735 */           Type[] types = (Type[])this.val$cache.get(member);
/* 736 */           if (types == null) {
/* 737 */             this.val$cache.put(member, types = member.getSignature().getArgumentTypes());
/*     */           }
/* 739 */           return types;
/*     */         }
/* 741 */       };
...
/*     */           }
/* 750 */         });
/* 751 */         String[] names = (String[])buckets.keySet().toArray(new String[buckets.size()]);
/* 752 */         string_switch(e, names, 1, new ObjectSwitchCallback() {
/*     */           public void processCase(Object key, Label dontUseEnd) throws Exception {
/* 754 */             EmitUtils.member_helper_size(this.val$e, (List)buckets.get(key), callback, cached, def, end);
/*     */           }
/*     */           
/* 757 */           public void processDefault() throws Exception { this.val$e.goTo(def); }
/*     */         });
/*     */       }
/*     */       else {
...
/*     */     throws Exception
/*     */   {
/* 782 */     Map buckets = CollectionUtils.bucket(members, new Transformer() {
/*     */       public Object transform(Object value) {
/* 784 */         return new Integer(this.val$typer.getParameterTypes((MethodInfo)value).length);
/*     */       }
/* 786 */     });
/* 787 */     e.dup();
/* 788 */     e.arraylength();
...
/* 791 */         List bucket = (List)this.val$buckets.get(new Integer(key));
/* 792 */         EmitUtils.member_helper_type(e, bucket, callback, typer, def, end, new BitSet());
/*     */       }
/*     */       
/* 795 */       public void processDefault() throws Exception { e.goTo(def); }
/*     */     });
/*     */   }
/*     */   
/*     */ 
...
/* 808 */       MethodInfo member = (MethodInfo)members.get(0);
...
/*     */     }
/*     */     else {
/* 825 */       Type[] example = typer.getParameterTypes((MethodInfo)members.get(0));
...
/*     */           public Object transform(Object value) {
/* 832 */             return TypeUtils.emulateClassGetName(this.val$typer.getParameterTypes((MethodInfo)value)[j]);
/*     */           }
/*     */         });
...
/* 852 */         String[] names = (String[])buckets.keySet().toArray(new String[buckets.size()]);
/* 853 */         string_switch(e, names, 1, new ObjectSwitchCallback() {
/*     */           public void processCase(Object key, Label dontUseEnd) throws Exception {
/* 855 */             EmitUtils.member_helper_type(this.val$e, (List)fbuckets.get(key), callback, typer, def, end, checked);
/*     */           }
/*     */           
/* 858 */           public void processDefault() throws Exception { this.val$e.goTo(def); }
/*     */         });
/*     */       }
/*     */     }
/*     */   }
...
/*     */   {
/* 920 */     Set set = exceptions == null ? Collections.EMPTY_SET : new HashSet(Arrays.asList(exceptions));
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\core\EmitUtils.class
