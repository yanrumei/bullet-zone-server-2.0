...
/*     */   
/*  40 */   private static volatile Map<ClassLoader, ClassLoaderData> CACHE = new WeakHashMap();
/*     */   
...
/*     */   private Object key;
/*  48 */   private boolean useCache = true;
/*     */   private String className;
/*     */   private boolean attemptLoad;
/*     */   
/*     */   protected static class ClassLoaderData {
/*  53 */     private final Set<String> reservedClassNames = new HashSet();
/*     */     
/*     */ 
/*     */ 
/*     */ 
...
/*     */     };
/*     */     
/*  79 */     private static final Function<AbstractClassGenerator, Object> GET_KEY = new Function() {
...
/*     */       }
/*  89 */       this.classLoader = new WeakReference(classLoader);
/*  90 */       Function<AbstractClassGenerator, Object> load = new Function()
/*     */       {
/*     */         public Object apply(AbstractClassGenerator gen) {
...
/* 101 */       return (ClassLoader)this.classLoader.get();
/*     */     }
/*     */     
...
/*     */   {
/* 123 */     return new WeakReference(klass);
/*     */   }
/*     */   
...
/*     */     String name;
/*     */     
/* 133 */     public Source(String name) { this.name = name; }
/*     */   }
/*     */   
...
/*     */   {
/* 238 */     return (AbstractClassGenerator)CURRENT.get();
/*     */   }
/*     */   
/*     */   public ClassLoader getClassLoader() {
...
/* 277 */       ClassLoaderData data = (ClassLoaderData)cache.get(loader);
/* 278 */       if (data == null) {
/* 279 */         synchronized (AbstractClassGenerator.class) {
/* 280 */           cache = CACHE;
/* 281 */           data = (ClassLoaderData)cache.get(loader);
/* 282 */           if (data == null) {
/* 283 */             Map<ClassLoader, ClassLoaderData> newCache = new WeakHashMap(cache);
...
/* 308 */     CURRENT.set(this);
/*     */     try {
/* 310 */       ClassLoader classLoader = data.getClassLoader();
/* 311 */       if (classLoader == null)
/*     */       {
/* 313 */         throw new IllegalStateException("ClassLoader is null while trying to define class " + getClassName() + ". It seems that the loader has been expired from a weak reference somehow. Please file an issue at cglib's issue tracker.");
/*     */       }
/*     */       
...
/*     */         try {
/* 323 */           Class gen = classLoader.loadClass(getClassName());
/* 324 */           return gen;
/*     */         }
...
/* 332 */       Class gen; synchronized (classLoader) { Class gen;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\core\AbstractClassGenerator.class
