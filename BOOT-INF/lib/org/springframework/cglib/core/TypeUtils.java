...
/*     */     }
/* 113 */     List list = Arrays.asList(types);
...
/* 188 */     List names = parseTypes(s, 0, s.length());
/* 189 */     Type[] types = new Type[names.size()];
/* 190 */     for (int i = 0; i < types.length; i++) {
/* 191 */       types[i] = Type.getType((String)names.get(i));
/*     */     }
/* 193 */     return types;
/*     */   }
/*     */   
...
/* 212 */     List types = new ArrayList(5);
/*     */     for (;;) {
...
/* 405 */     int i = 0; for (int len = s.length(); i < len; i++) {
/* 406 */       char c = s.charAt(i);
/* 407 */       switch (c) {
/* 408 */       case '$':  sb.append("$24"); break;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\core\TypeUtils.class
