...
/* 134 */     final CodeEmitter e = super.begin_method(1, PROVIDER_SET_BY_INDEX, null);
/* 135 */     e.load_this();
/* 136 */     e.load_arg(1);
/* 137 */     e.load_arg(0);
...
/*     */       }
/*     */       
/* 146 */       public void processDefault() throws Exception { e.throw_exception(FieldProviderTransformer.ILLEGAL_ARGUMENT_EXCEPTION, "Unknown field index");
/*     */       }
/* 148 */     });
/* 149 */     e.end_method();
/*     */   }
...
/* 153 */     final CodeEmitter e = super.begin_method(1, PROVIDER_GET_BY_INDEX, null);
/* 154 */     e.load_this();
/* 155 */     e.load_arg(0);
...
/*     */       }
/*     */       
/* 164 */       public void processDefault() throws Exception { e.throw_exception(FieldProviderTransformer.ILLEGAL_ARGUMENT_EXCEPTION, "Unknown field index");
/*     */       }
/* 166 */     });
/* 167 */     e.end_method();
/*     */   }
...
/*     */       }
/*     */       
/* 184 */       public void processDefault() { e.throw_exception(FieldProviderTransformer.ILLEGAL_ARGUMENT_EXCEPTION, "Unknown field name");
/*     */       }
/* 186 */     });
/* 187 */     e.end_method();
/*     */   }
...
/*     */       }
/*     */       
/* 203 */       public void processDefault() { e.throw_exception(FieldProviderTransformer.ILLEGAL_ARGUMENT_EXCEPTION, "Unknown field name");
/*     */       }
/* 205 */     });
/* 206 */     e.end_method();
/*     */   }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\transform\impl\FieldProviderTransformer.class
