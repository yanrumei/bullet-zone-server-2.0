...
/* 142 */     new CodeEmitter(super.begin_method(access, sig, exceptions)) {
...
/* 148 */             helper(towner, InterceptFieldTransformer.readMethodSig(name, desc)); return;
/*     */           }
/*     */           
/*     */           break;
/*     */         case 181: 
/* 153 */           if (InterceptFieldTransformer.this.filter.acceptWrite(towner, name)) {
/* 154 */             helper(towner, InterceptFieldTransformer.writeMethodSig(name, desc)); return;
/*     */           }
/*     */           break;
/*     */         }
/*     */         
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\transform\impl\InterceptFieldTransformer.class
