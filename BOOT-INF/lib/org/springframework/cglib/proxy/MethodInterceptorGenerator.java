...
/*     */   }
/*     */   
/*  80 */   private String getMethodProxyField(Signature impl) { return impl.getName() + "$Proxy"; }
/*     */   
...
/* 170 */     for (Iterator i = methodsByClass.keySet().iterator(); i.hasNext();) {
/* 171 */       ClassInfo classInfo = (ClassInfo)i.next();
/*     */       
/* 173 */       List classMethods = (List)methodsByClass.get(classInfo);
/* 174 */       e.push(2 * classMethods.size());
/* 175 */       e.newarray(Constants.TYPE_STRING);
/* 176 */       for (int index = 0; index < classMethods.size(); index++) {
/* 177 */         MethodInfo method = (MethodInfo)classMethods.get(index);
...
/*     */       
/* 195 */       for (int index = 0; index < classMethods.size(); index++) {
/* 196 */         MethodInfo method = (MethodInfo)classMethods.get(index);
...
/*     */       }
/*     */       
/* 228 */       public void processDefault() { e.aconst_null();
/* 229 */         e.return_value();
/*     */       }
/* 231 */     };
/* 232 */     EmitUtils.string_switch(e, 
/* 233 */       (String[])sigMap.keySet().toArray(new String[0]), 1, callback);
/*     */     
/*     */ 
/* 236 */     e.end_method();
/*     */   }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\cglib\proxy\MethodInterceptorGenerator.class
