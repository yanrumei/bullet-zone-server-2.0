...
/*     */ {
/*  63 */   private static final boolean setRemoveOnCancelPolicyAvailable = ClassUtils.hasMethod(ScheduledThreadPoolExecutor.class, "setRemoveOnCancelPolicy", new Class[] { Boolean.TYPE });
/*     */   
/*     */ 
/*  66 */   private volatile int poolSize = 1;
/*     */   
/*  68 */   private volatile boolean removeOnCancelPolicy = false;
/*     */   
/*     */ 
/*     */ 
...
/* 252 */         taskToUse = new DelegatingErrorHandlingCallable(task, this.errorHandler);
/*     */       }
...
/*     */     {
/*     */       try {
/* 386 */         return (V)this.delegate.call();
/*     */       }
/*     */       catch (Throwable t) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\scheduling\concurrent\ThreadPoolTaskScheduler.class
