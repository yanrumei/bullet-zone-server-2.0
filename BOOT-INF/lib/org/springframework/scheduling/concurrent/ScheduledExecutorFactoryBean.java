...
/*     */ {
/*  80 */   private static final boolean setRemoveOnCancelPolicyAvailable = ClassUtils.hasMethod(ScheduledThreadPoolExecutor.class, "setRemoveOnCancelPolicy", new Class[] { Boolean.TYPE });
/*     */   
/*     */ 
...
/*     */   
/*  87 */   private boolean removeOnCancelPolicy = false;
/*     */   
/*  89 */   private boolean continueScheduledExecutionAfterException = false;
/*     */   
/*  91 */   private boolean exposeUnconfigurableExecutor = false;
/*     */   
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 176 */     this.exposedExecutor = (this.exposeUnconfigurableExecutor ? Executors.unconfigurableScheduledExecutorService(executor) : executor);
/*     */     
/* 178 */     return executor;
/*     */   }
/*     */   
...
/*     */   {
/* 233 */     return this.continueScheduledExecutionAfterException ? new DelegatingErrorHandlingRunnable(task
/* 234 */       .getRunnable(), TaskUtils.LOG_AND_SUPPRESS_ERROR_HANDLER) : new DelegatingErrorHandlingRunnable(task
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\scheduling\concurrent\ScheduledExecutorFactoryBean.class
