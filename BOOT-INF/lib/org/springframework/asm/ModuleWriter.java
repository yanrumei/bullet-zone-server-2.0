...
/*     */     
/*     */ 
/* 185 */     this.requires.putShort(this.cw.newModule(module)).putShort(access).putShort(version == null ? 0 : this.cw.newUTF8(version));
/* 186 */     this.requireCount += 1;
/* 187 */     this.size += 6;
/*     */   }
/*     */   
...
/*     */ 
/*     */ 
/* 265 */       out.putShort(this.cw.newUTF8("ModulePackages")).putInt(2 + 2 * this.packageCount).putShort(this.packageCount).putByteArray(this.packages.data, 0, this.packages.length);
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\asm\ModuleWriter.class
