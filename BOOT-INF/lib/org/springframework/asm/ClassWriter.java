...
/*  648 */     this.compute = ((flags & 0x1) != 0 ? 2 : (flags & 0x2) != 0 ? 0 : 3);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */     }
/*  721 */     if (debug != null) {
/*  722 */       this.sourceDebug = new ByteVector().encodeUTF8(debug, 0, Integer.MAX_VALUE);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*  730 */     return 
/*      */     
/*  732 */       this.moduleWriter = new ModuleWriter(this, newModule(name), access, version == null ? 0 : newUTF8(version));
/*      */   }
/*      */   
/*      */ 
...
/* 1031 */       boolean hasFrames = false;
/* 1032 */       mb = this.firstMethod;
/* 1033 */       while (mb != null) {
/* 1034 */         hasFrames |= mb.frameCount > 0;
...
/* 1047 */       this.compute = (hasFrames ? 1 : 0);
/* 1048 */       this.hasAsmInsns = false;
/* 1049 */       new ClassReader(out.data).accept(this, (hasFrames ? 8 : 0) | 0x100);
/*      */       
/*      */ 
...
/* 1382 */     hashCode &= 0x7FFFFFFF;
/* 1383 */     Item result = this.items[(hashCode % this.items.length)];
/* 1384 */     label250: while (result != null) {
...
/* 1393 */         for (int p = 0;; p++) { if (p >= length) break label250;
...
/* 1403 */     if (result != null) {
/* 1404 */       int bootstrapMethodIndex = result.index;
...
/* 1684 */     this.key.hashCode = (0x7FFFFFFF & 31 + type.hashCode() + offset);
...
/* 1702 */     Item result = new Item(this.typeCount, this.key);
/* 1703 */     put(result);
...
/* 1730 */     this.key2.longVal = (type1 | type2 << 32);
/* 1731 */     this.key2.hashCode = (0x7FFFFFFF & 32 + type1 + type2);
...
/* 1780 */     } while (!c.isAssignableFrom(d));
...
/* 1827 */         while (j != null) {
/* 1828 */           int index = j.hashCode % newItems.length;
/* 1829 */           Item k = j.next;
/* 1830 */           j.next = newItems[index];
/* 1831 */           newItems[index] = j;
/* 1832 */           j = k;
/*      */         }
/*      */       }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\asm\ClassWriter.class
