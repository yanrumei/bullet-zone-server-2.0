...
/*  75 */   private boolean lookupOnStartup = true;
/*     */   
/*  77 */   private boolean cache = true;
/*     */   
/*  79 */   private boolean exposeAccessContext = false;
/*     */   
...
/*     */       {
/* 206 */         TypeConverter converter = this.beanFactory != null ? this.beanFactory.getTypeConverter() : new SimpleTypeConverter();
/*     */         try {
...
/*     */         {
/* 213 */           throw new IllegalArgumentException("Default object [" + this.defaultObject + "] of type [" + this.defaultObject.getClass().getName() + "] is not of expected type [" + getExpectedType().getName() + "] and cannot be converted either", ex);
/*     */         }
/*     */       }
/*     */       
...
/* 339 */         proxyFactory.addAdvice(new JndiObjectFactoryBean.JndiContextExposingInterceptor(jof.getJndiTemplate()));
/*     */       }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\jndi\JndiObjectFactoryBean.class
