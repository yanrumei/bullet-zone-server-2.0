...
/*     */   
/*  70 */   private final Map<AnnotatedElementKey, Method> targetMethodCache = new ConcurrentHashMap(64);
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 111 */       evaluationContext.setBeanResolver(new BeanFactoryResolver(beanFactory));
/*     */     }
/* 113 */     return evaluationContext;
/*     */   }
/*     */   
...
/* 121 */     return ((Boolean)getExpression(this.conditionCache, methodKey, conditionExpression).getValue(evalContext, Boolean.TYPE)).booleanValue();
/*     */   }
/*     */   
/*     */   public boolean unless(String unlessExpression, AnnotatedElementKey methodKey, EvaluationContext evalContext) {
/* 125 */     return ((Boolean)getExpression(this.unlessCache, methodKey, unlessExpression).getValue(evalContext, Boolean.TYPE)).booleanValue();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 140 */     Method targetMethod = (Method)this.targetMethodCache.get(methodKey);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\cache\interceptor\CacheOperationExpressionEvaluator.class
