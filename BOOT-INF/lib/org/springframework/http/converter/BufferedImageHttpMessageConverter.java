...
/*     */ {
/*  70 */   private final List<MediaType> readableMediaTypes = new ArrayList();
/*     */   
...
/*  79 */     String[] arrayOfString1 = readerMediaTypes;int i = arrayOfString1.length; for (String str1 = 0; str1 < i; str1++) { mediaType = arrayOfString1[str1];
...
/*  86 */     String[] arrayOfString2 = writerMediaTypes;str1 = arrayOfString2.length; for (String mediaType = 0; mediaType < str1; mediaType++) { String mediaType = arrayOfString2[mediaType];
...
/* 171 */         imageReader = (ImageReader)imageReaders.next();
...
/*     */ 
/*     */ 
/*     */   public void write(final BufferedImage image, MediaType contentType, HttpOutputMessage outputMessage)
...
/* 245 */         imageWriter = (ImageWriter)imageWriters.next();
...
/*     */   }
/*     */   
/*     */   private ImageOutputStream createImageOutputStream(OutputStream os)
/*     */     throws IOException
/*     */   {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\converter\BufferedImageHttpMessageConverter.class
