...
/*     */       }
/*     */       
/*  62 */       Collection<ResourceRegion> regions = (Collection)object;
...
/*     */     }
/*     */     else {
/* 133 */       Collection<ResourceRegion> regions = (Collection)object;
/* 134 */       if (regions.size() == 1) {
/* 135 */         writeResourceRegion((ResourceRegion)regions.iterator().next(), outputMessage);
/*     */       }
/*     */       else {
/* 138 */         writeResourceRegionCollection((Collection)object, outputMessage);
/*     */       }
/*     */     }
/*     */   }
/*     */   
...
/*     */     try {
/* 158 */       StreamUtils.copyRange(in, outputMessage.getBody(), start, end); return;
/*     */     }
/*     */     finally {
/*     */       try {
/* 162 */         in.close();
...
/*     */     
/* 181 */     Iterator localIterator = resourceRegions.iterator(); for (;;) { if (localIterator.hasNext()) { ResourceRegion region = (ResourceRegion)localIterator.next();
...
/*     */           try
/*     */           {
/* 204 */             in.close(); } catch (IOException localIOException) {} } finally { try { in.close();
/*     */           }
/*     */           catch (IOException localIOException1) {}
/*     */         }
/*     */       }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\converter\ResourceRegionHttpMessageConverter.class
