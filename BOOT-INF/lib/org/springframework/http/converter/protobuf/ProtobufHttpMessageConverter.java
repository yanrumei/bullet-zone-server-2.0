...
/*     */   
/*  69 */   private static final ProtobufFormatter JSON_FORMAT = new JsonFormat();
/*     */   
/*  71 */   private static final ProtobufFormatter XML_FORMAT = new XmlFormat();
/*     */   
/*  73 */   private static final ProtobufFormatter HTML_FORMAT = new HtmlFormat();
/*     */   
/*     */ 
/*  76 */   private static final ConcurrentHashMap<Class<?>, Method> methodCache = new ConcurrentHashMap();
/*     */   
...
/*     */     throws Exception
/*     */   {
/* 204 */     Method method = (Method)methodCache.get(clazz);
/* 205 */     if (method == null) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\converter\protobuf\ProtobufHttpMessageConverter.class
