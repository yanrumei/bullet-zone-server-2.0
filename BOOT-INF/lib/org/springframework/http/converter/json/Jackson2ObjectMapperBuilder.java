...
/*     */ {
/*  93 */   private boolean createXmlMapper = false;
/*     */   
...
/*     */   
/* 111 */   private final Map<Class<?>, Class<?>> mixIns = new HashMap();
/*     */   
/* 113 */   private final Map<Class<?>, JsonSerializer<?>> serializers = new LinkedHashMap();
/*     */   
/* 115 */   private final Map<Class<?>, JsonDeserializer<?>> deserializers = new LinkedHashMap();
/*     */   
/* 117 */   private final Map<Object, Boolean> features = new HashMap();
/*     */   
/*     */   private List<Module> modules;
/*     */   
/*     */   private Class<? extends Module>[] moduleClasses;
/*     */   
/* 123 */   private boolean findModulesViaServiceLoader = false;
/*     */   
/* 125 */   private boolean findWellKnownModules = true;
/*     */   
...
/*     */   {
/* 488 */     this.modules = new LinkedList(modules);
...
/*     */     {
/*     */ 
/* 585 */       mapper = this.defaultUseWrapper != null ? new XmlObjectMapperInitializer(null).create(this.defaultUseWrapper.booleanValue()) : new XmlObjectMapperInitializer(null).create();
/*     */     }
/*     */     else {
...
/* 611 */       for (localObject1 = this.modules.iterator(); ((Iterator)localObject1).hasNext();) { module = (Module)((Iterator)localObject1).next();
/*     */         
/* 613 */         objectMapper.registerModule(module);
/*     */       }
/*     */     Module module;
/* 616 */     if (this.moduleClasses != null) {
/* 617 */       localObject1 = this.moduleClasses;module = localObject1.length; for (Module localModule1 = 0; localModule1 < module; localModule1++) { Class<? extends Module> module = localObject1[localModule1];
...
/*     */     }
/*     */     
/* 649 */     for (Object localObject1 = this.mixIns.keySet().iterator(); ((Iterator)localObject1).hasNext();) { Class<?> target = (Class)((Iterator)localObject1).next();
/* 650 */       objectMapper.addMixIn(target, (Class)this.mixIns.get(target));
/*     */     }
/*     */     
/* 653 */     if ((!this.serializers.isEmpty()) || (!this.deserializers.isEmpty())) {
/* 654 */       module = new SimpleModule();
/* 655 */       addSerializers((SimpleModule)module);
/* 656 */       addDeserializers((SimpleModule)module);
/* 657 */       objectMapper.registerModule((Module)module);
/*     */     }
/*     */     
/* 660 */     customizeDefaultFeatures(objectMapper);
/* 661 */     for (Object module = this.features.keySet().iterator(); ((Iterator)module).hasNext();) { Object feature = ((Iterator)module).next();
...
/* 689 */       module.addSerializer(type, (JsonSerializer)this.serializers.get(type));
/*     */     }
/*     */   }
/*     */   
...
/* 696 */       module.addDeserializer(type, (JsonDeserializer)this.deserializers.get(type));
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/* 807 */       return new XmlMapper(xmlInputFactory());
/*     */     }
/*     */     
...
/* 813 */       return new XmlMapper(new XmlFactory(xmlInputFactory()), module);
/*     */     }
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\converter\json\Jackson2ObjectMapperBuilder.class
