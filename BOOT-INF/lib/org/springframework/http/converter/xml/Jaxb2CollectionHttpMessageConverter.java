...
/*     */     {
/* 169 */       throw new HttpMessageNotReadableException("Could not unmarshal to [" + elementClass + "]: " + ex.getMessage(), ex);
/*     */     }
/*     */     catch (JAXBException ex) {
/* 172 */       throw new HttpMessageConversionException("Could not instantiate JAXBContext: " + ex.getMessage(), ex);
/*     */     }
...
/*     */       try {
/* 189 */         return (Collection)collectionClass.newInstance();
/*     */       }
/*     */       catch (Throwable ex)
/*     */       {
/* 193 */         throw new IllegalArgumentException("Could not instantiate collection class: " + collectionClass.getName(), ex);
/*     */       }
/*     */     }
...
/* 200 */       return new TreeSet();
/*     */     }
/*     */     
/* 203 */     return new LinkedHashSet();
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\converter\xml\Jaxb2CollectionHttpMessageConverter.class
