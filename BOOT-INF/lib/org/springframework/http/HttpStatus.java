...
/*     */   {
/* 492 */     for (HttpStatus status : ) {
/* 493 */       if (status.value == statusCode) {
/* 494 */         return status;
/*     */       }
/*     */     }
/* 497 */     throw new IllegalArgumentException("No matching constant for [" + statusCode + "]");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 527 */       int seriesCode = status / 100;
/* 528 */       for (Series series : values()) {
/* 529 */         if (series.value == seriesCode) {
/* 530 */           return series;
/*     */         }
/*     */       }
/* 533 */       throw new IllegalArgumentException("No matching constant for [" + status + "]");
/*     */     }
/*     */     
/*     */     public static Series valueOf(HttpStatus status) {
/* 537 */       return valueOf(status.value);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\HttpStatus.class
