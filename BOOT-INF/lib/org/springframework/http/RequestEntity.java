...
/*     */   {
/*  88 */     this(body, null, method, url, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/* 447 */       return new RequestEntity(this.headers, this.method, this.url);
/*     */     }
/*     */     
/*     */     public <T> RequestEntity<T> body(T body)
/*     */     {
/* 452 */       return new RequestEntity(body, this.headers, this.method, this.url);
/*     */     }
/*     */     
/*     */     public <T> RequestEntity<T> body(T body, Type type)
/*     */     {
/* 457 */       return new RequestEntity(body, this.headers, this.method, this.url, type);
/*     */     }
/*     */   }
/*     */   
/*     */   public static abstract interface BodyBuilder
/*     */     extends RequestEntity.HeadersBuilder<BodyBuilder>
/*     */   {
...
/*     */     
/*     */     public abstract <T> RequestEntity<T> body(T paramT, Type paramType);
/*     */   }
/*     */   
...
/*     */     
/*     */     public abstract B accept(MediaType... paramVarArgs);
/*     */     
/*     */     public abstract B acceptCharset(Charset... paramVarArgs);
/*     */     
/*     */     public abstract B ifModifiedSince(long paramLong);
/*     */     
/*     */     public abstract B ifNoneMatch(String... paramVarArgs);
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\RequestEntity.class
