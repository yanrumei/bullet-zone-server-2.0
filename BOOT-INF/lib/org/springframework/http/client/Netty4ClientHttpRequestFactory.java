...
/*  91 */     this.eventLoopGroup = new NioEventLoopGroup(ioWorkerCount);
...
/* 194 */       .handler(new ChannelInitializer()
/*     */       {
...
/* 201 */             pipeline.addLast(new ChannelHandler[] { Netty4ClientHttpRequestFactory.this.sslContext.newHandler(channel.alloc(), uri.getHost(), uri.getPort()) });
/*     */           }
/* 203 */           pipeline.addLast(new ChannelHandler[] { new HttpClientCodec() });
/* 204 */           pipeline.addLast(new ChannelHandler[] { new HttpObjectAggregator(Netty4ClientHttpRequestFactory.this.maxResponseSize) });
/* 205 */           if (Netty4ClientHttpRequestFactory.this.readTimeout > 0) {
/* 206 */             pipeline.addLast(new ChannelHandler[] { new ReadTimeoutHandler(Netty4ClientHttpRequestFactory.this.readTimeout, TimeUnit.MILLISECONDS) });
/*     */           }
/*     */           
/*     */         }
/* 210 */       });
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\client\Netty4ClientHttpRequestFactory.class
