...
/* 132 */       return contentType != null ? new BasicHeader("Content-Type", contentType.toString()) : null;
/*     */     }
/*     */     
/*     */     public Header getContentEncoding()
/*     */     {
/* 137 */       String contentEncoding = this.headers.getFirst("Content-Encoding");
/* 138 */       return contentEncoding != null ? new BasicHeader("Content-Encoding", contentEncoding) : null;
/*     */     }
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\http\client\HttpComponentsStreamingClientHttpRequest.class
