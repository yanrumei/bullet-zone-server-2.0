...
/*     */   
/*     */   static {
/* 134 */     if (ClassUtils.isPresent("com.fasterxml.jackson.databind.ObjectMapper", RestTemplate.class
/* 135 */       .getClassLoader())) {} }
/* 136 */   private static final boolean jackson2Present = ClassUtils.isPresent("com.fasterxml.jackson.core.JsonGenerator", RestTemplate.class
/* 137 */     .getClassLoader());
/*     */   
/*     */ 
...
/*     */   
/*     */ 
/* 148 */   private final List<HttpMessageConverter<?>> messageConverters = new ArrayList();
/*     */   
/* 150 */   private ResponseErrorHandler errorHandler = new DefaultResponseErrorHandler();
/*     */   
/* 152 */   private UriTemplateHandler uriTemplateHandler = new DefaultUriTemplateHandler();
/*     */   
/* 154 */   private final ResponseExtractor<HttpHeaders> headersExtractor = new HeadersExtractor(null);
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 295 */     return (T)execute(url, HttpMethod.GET, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
...
/* 303 */     return (T)execute(url, HttpMethod.GET, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
...
/* 311 */     return (T)execute(url, HttpMethod.GET, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/* 320 */     return (ResponseEntity)execute(url, HttpMethod.GET, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/* 329 */     return (ResponseEntity)execute(url, HttpMethod.GET, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
...
/* 336 */     return (ResponseEntity)execute(url, HttpMethod.GET, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws RestClientException
/*     */   {
/* 344 */     return (HttpHeaders)execute(url, HttpMethod.HEAD, null, headersExtractor(), uriVariables);
/*     */   }
/*     */   
/*     */   public HttpHeaders headForHeaders(String url, Map<String, ?> uriVariables) throws RestClientException
/*     */   {
/* 349 */     return (HttpHeaders)execute(url, HttpMethod.HEAD, null, headersExtractor(), uriVariables);
/*     */   }
/*     */   
/*     */   public HttpHeaders headForHeaders(URI url) throws RestClientException
/*     */   {
/* 354 */     return (HttpHeaders)execute(url, HttpMethod.HEAD, null, headersExtractor());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 363 */     HttpHeaders headers = (HttpHeaders)execute(url, HttpMethod.POST, requestCallback, headersExtractor(), uriVariables);
...
/* 370 */     HttpHeaders headers = (HttpHeaders)execute(url, HttpMethod.POST, requestCallback, headersExtractor(), uriVariables);
...
/* 377 */     HttpHeaders headers = (HttpHeaders)execute(url, HttpMethod.POST, requestCallback, headersExtractor());
...
/*     */     
/* 387 */     HttpMessageConverterExtractor<T> responseExtractor = new HttpMessageConverterExtractor(responseType, getMessageConverters(), this.logger);
/* 388 */     return (T)execute(url, HttpMethod.POST, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 397 */     HttpMessageConverterExtractor<T> responseExtractor = new HttpMessageConverterExtractor(responseType, getMessageConverters(), this.logger);
/* 398 */     return (T)execute(url, HttpMethod.POST, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
...
/*     */     
/* 405 */     HttpMessageConverterExtractor<T> responseExtractor = new HttpMessageConverterExtractor(responseType, getMessageConverters());
/* 406 */     return (T)execute(url, HttpMethod.POST, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/* 415 */     return (ResponseEntity)execute(url, HttpMethod.POST, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/* 424 */     return (ResponseEntity)execute(url, HttpMethod.POST, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
...
/* 431 */     return (ResponseEntity)execute(url, HttpMethod.POST, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 440 */     execute(url, HttpMethod.PUT, requestCallback, null, uriVariables);
/*     */   }
/*     */   
/*     */   public void put(String url, Object request, Map<String, ?> uriVariables) throws RestClientException
/*     */   {
/* 445 */     RequestCallback requestCallback = httpEntityCallback(request);
/* 446 */     execute(url, HttpMethod.PUT, requestCallback, null, uriVariables);
/*     */   }
/*     */   
/*     */   public void put(URI url, Object request) throws RestClientException
/*     */   {
/* 451 */     RequestCallback requestCallback = httpEntityCallback(request);
/* 452 */     execute(url, HttpMethod.PUT, requestCallback, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     
/* 464 */     HttpMessageConverterExtractor<T> responseExtractor = new HttpMessageConverterExtractor(responseType, getMessageConverters(), this.logger);
/* 465 */     return (T)execute(url, HttpMethod.PATCH, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 474 */     HttpMessageConverterExtractor<T> responseExtractor = new HttpMessageConverterExtractor(responseType, getMessageConverters(), this.logger);
/* 475 */     return (T)execute(url, HttpMethod.PATCH, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/*     */     
/* 484 */     HttpMessageConverterExtractor<T> responseExtractor = new HttpMessageConverterExtractor(responseType, getMessageConverters());
/* 485 */     return (T)execute(url, HttpMethod.PATCH, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws RestClientException
/*     */   {
/* 493 */     execute(url, HttpMethod.DELETE, null, null, uriVariables);
/*     */   }
/*     */   
/*     */   public void delete(String url, Map<String, ?> uriVariables) throws RestClientException
/*     */   {
/* 498 */     execute(url, HttpMethod.DELETE, null, null, uriVariables);
/*     */   }
/*     */   
/*     */   public void delete(URI url) throws RestClientException
/*     */   {
/* 503 */     execute(url, HttpMethod.DELETE, null, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 512 */     HttpHeaders headers = (HttpHeaders)execute(url, HttpMethod.OPTIONS, null, headersExtractor, uriVariables);
...
/* 519 */     HttpHeaders headers = (HttpHeaders)execute(url, HttpMethod.OPTIONS, null, headersExtractor, uriVariables);
...
/* 526 */     HttpHeaders headers = (HttpHeaders)execute(url, HttpMethod.OPTIONS, null, headersExtractor);
...
/* 539 */     return (ResponseEntity)execute(url, method, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/* 548 */     return (ResponseEntity)execute(url, method, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/* 557 */     return (ResponseEntity)execute(url, method, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/* 567 */     return (ResponseEntity)execute(url, method, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/* 577 */     return (ResponseEntity)execute(url, method, requestCallback, responseExtractor, uriVariables);
/*     */   }
/*     */   
/*     */ 
...
/* 587 */     return (ResponseEntity)execute(url, method, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/* 598 */     return (ResponseEntity)execute(requestEntity.getUrl(), requestEntity.getMethod(), requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/* 610 */     return (ResponseEntity)execute(requestEntity.getUrl(), requestEntity.getMethod(), requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 621 */     return (T)doExecute(expanded, method, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/* 629 */     return (T)doExecute(expanded, method, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
...
/*     */     throws RestClientException
/*     */   {
/* 636 */     return (T)doExecute(url, method, requestCallback, responseExtractor);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 662 */       Object localObject1; if (responseExtractor != null) {
/* 663 */         return (T)responseExtractor.extractData(response);
/*     */       }
/*     */       
/* 666 */       return null;
/*     */     }
...
/*     */       
/* 674 */       throw new ResourceAccessException("I/O error on " + method.name() + " request for \"" + resource + "\": " + ex.getMessage(), ex);
/*     */     }
/*     */     finally {
...
/*     */   {
/* 718 */     return new AcceptHeaderRequestCallback(responseType, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 726 */     return new HttpEntityRequestCallback(requestBody, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 734 */     return new HttpEntityRequestCallback(requestBody, responseType, null);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 741 */     return new ResponseEntityResponseExtractor(responseType);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */         }
/* 770 */         List<MediaType> allSupportedMediaTypes = new ArrayList();
...
/*     */             }
/*     */           }
/* 777 */           else if ((converter instanceof GenericHttpMessageConverter)) {
...
/* 796 */       List<MediaType> result = new ArrayList(supportedMediaTypes.size());
...
/* 841 */           for (Map.Entry<String, List<String>> entry : requestHeaders.entrySet()) {
/* 842 */             httpHeaders.put((String)entry.getKey(), new LinkedList((Collection)entry.getValue()));
/*     */           }
/*     */         }
...
/*     */         
/* 853 */         Object requestBodyType = (this.requestEntity instanceof RequestEntity) ? ((RequestEntity)this.requestEntity).getType() : requestBodyClass;
...
/* 857 */         for (HttpMessageConverter<?> messageConverter : RestTemplate.this.getMessageConverters()) { GenericHttpMessageConverter<Object> genericMessageConverter;
/* 858 */           if ((messageConverter instanceof GenericHttpMessageConverter)) {
/* 859 */             genericMessageConverter = (GenericHttpMessageConverter)messageConverter;
/* 860 */             if (genericMessageConverter.canWrite((Type)requestBodyType, requestBodyClass, requestContentType)) {
/* 861 */               if (!requestHeaders.isEmpty()) {
/* 862 */                 for (Map.Entry<String, List<String>> entry : requestHeaders.entrySet()) {
/* 863 */                   httpHeaders.put((String)entry.getKey(), new LinkedList((Collection)entry.getValue()));
/*     */                 }
/*     */               }
...
/*     */               }
/*     */               
/* 876 */               genericMessageConverter.write(requestBody, (Type)requestBodyType, requestContentType, httpRequest);
/*     */               
/* 878 */               return;
/*     */             }
/*     */           }
/* 881 */           else if (messageConverter.canWrite(requestBodyClass, requestContentType)) {
/* 882 */             if (!requestHeaders.isEmpty()) {
/* 883 */               for (Object entry : requestHeaders.entrySet()) {
/* 884 */                 httpHeaders.put((String)((Map.Entry)entry).getKey(), new LinkedList((Collection)((Map.Entry)entry).getValue()));
/*     */               }
/*     */             }
...
/*     */             }
/*     */             
/* 897 */             messageConverter.write(requestBody, requestContentType, httpRequest);
/*     */             
/* 899 */             return;
/*     */           }
/*     */         }
...
/* 922 */         this.delegate = new HttpMessageConverterExtractor(responseType, RestTemplate.this.getMessageConverters(), RestTemplate.this.logger);
/*     */       }
/*     */       else {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\web\client\RestTemplate.class
