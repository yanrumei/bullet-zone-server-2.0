...
/*     */   {
/*  81 */     this(new SimpleAsyncTaskExecutor());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 289 */     new ListenableFutureAdapter(future)
/*     */     {
...
/* 388 */     new ListenableFutureAdapter(future)
/*     */     {
...
/*     */ 
/*     */ 
/*     */   public <T> ListenableFuture<T> execute(String url, HttpMethod method, AsyncRequestCallback requestCallback, ResponseExtractor<T> responseExtractor, Object... uriVariables)
/*     */     throws RestClientException
/*     */   {
...
/*     */   
/*     */ 
/*     */   public <T> ListenableFuture<T> execute(String url, HttpMethod method, AsyncRequestCallback requestCallback, ResponseExtractor<T> responseExtractor, Map<String, ?> uriVariables)
/*     */     throws RestClientException
/*     */   {
...
/* 504 */       return new ResponseExtractorFuture(method, url, responseFuture, responseExtractor);
/*     */     }
/*     */     catch (IOException ex)
/*     */     {
/* 508 */       throw new ResourceAccessException("I/O error on " + method.name() + " request for \"" + url + "\":" + ex.getMessage(), ex);
/*     */     }
/*     */   }
/*     */   
...
/*     */         }
/* 606 */         return (T)convertResponse(response);
/*     */       }
/*     */       catch (Throwable ex) {
...
/* 619 */       return (T)(this.responseExtractor != null ? this.responseExtractor.extractData(response) : null);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\web\client\AsyncRestTemplate.class
