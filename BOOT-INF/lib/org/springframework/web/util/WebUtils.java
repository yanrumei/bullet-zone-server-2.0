...
/*     */   {
/* 822 */     String origin = request.getHeaders().getOrigin();
/* 823 */     if (origin == null)
/* 824 */       return true;
/*     */     UriComponentsBuilder urlBuilder;
/*     */     UriComponentsBuilder urlBuilder;
/* 827 */     if ((request instanceof ServletServerHttpRequest))
/*     */     {
/* 829 */       HttpServletRequest servletRequest = ((ServletServerHttpRequest)request).getServletRequest();
/*     */       
/*     */ 
/*     */ 
/*     */ 
/* 834 */       urlBuilder = new UriComponentsBuilder().scheme(servletRequest.getScheme()).host(servletRequest.getServerName()).port(servletRequest.getServerPort()).adaptFromForwardedHeaders(request.getHeaders());
/*     */     }
/*     */     else {
/* 837 */       urlBuilder = UriComponentsBuilder.fromHttpRequest(request);
/*     */     }
/* 839 */     UriComponents actualUrl = urlBuilder.build();
/* 840 */     UriComponents originUrl = UriComponentsBuilder.fromOriginHeader(origin).build();
/* 841 */     return (ObjectUtils.nullSafeEquals(actualUrl.getHost(), originUrl.getHost())) && 
/* 842 */       (getPort(actualUrl) == getPort(originUrl));
/*     */   }
/*     */   
/*     */   private static int getPort(UriComponents uri) {
/* 846 */     int port = uri.getPort();
/* 847 */     if (port == -1) {
/* 848 */       if (("http".equals(uri.getScheme())) || ("ws".equals(uri.getScheme()))) {
/* 849 */         port = 80;
/*     */       }
/* 851 */       else if (("https".equals(uri.getScheme())) || ("wss".equals(uri.getScheme()))) {
/* 852 */         port = 443;
/*     */       }
/*     */     }
/* 855 */     return port;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\we\\util\WebUtils.class
