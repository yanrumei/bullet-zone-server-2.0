...
/* 143 */     return (contentType != null) && (contentType.contains("application/x-www-form-urlencoded")) && 
...
/* 150 */         requestEncoding = getCharacterEncoding();
/* 151 */         form = super.getParameterMap();
/* 152 */         for (nameIterator = form.keySet().iterator(); nameIterator.hasNext();) {
/* 153 */           String name = (String)nameIterator.next();
...
/* 156 */             String value = (String)valueIterator.next();
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\we\\util\ContentCachingRequestWrapper.class
