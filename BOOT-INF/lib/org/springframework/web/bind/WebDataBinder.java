...
/*     */   
/*  81 */   private boolean bindEmptyMultipartFiles = true;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */       try {
/* 264 */         if ((Boolean.TYPE == fieldType) || (Boolean.class == fieldType))
/*     */         {
...
/* 301 */       String key = (String)entry.getKey();
/* 302 */       List<MultipartFile> values = (List)entry.getValue();
/* 303 */       if (values.size() == 1) {
/* 304 */         MultipartFile value = (MultipartFile)values.get(0);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\web\bind\WebDataBinder.class
