...
/*     */   
/*  51 */   private static final ThreadLocal<RequestAttributes> requestAttributesHolder = new NamedThreadLocal("Request attributes");
/*     */   
/*     */ 
/*  54 */   private static final ThreadLocal<RequestAttributes> inheritableRequestAttributesHolder = new NamedInheritableThreadLocal("Request context");
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 105 */     RequestAttributes attributes = (RequestAttributes)requestAttributesHolder.get();
/* 106 */     if (attributes == null) {
/* 107 */       attributes = (RequestAttributes)inheritableRequestAttributesHolder.get();
/*     */     }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\web\context\request\RequestContextHolder.class
