...
/* 148 */         String attrName = (String)attrNames.nextElement();
...
/*     */   {
/* 179 */     beanFactory.registerScope("request", new RequestScope());
/* 180 */     beanFactory.registerScope("session", new SessionScope(false));
/* 181 */     beanFactory.registerScope("globalSession", new SessionScope(true));
/* 182 */     if (sc != null) {
...
/*     */     }
/*     */     
/* 189 */     beanFactory.registerResolvableDependency(ServletRequest.class, new RequestObjectFactory(null));
/* 190 */     beanFactory.registerResolvableDependency(ServletResponse.class, new ResponseObjectFactory(null));
/* 191 */     beanFactory.registerResolvableDependency(HttpSession.class, new SessionObjectFactory(null));
/* 192 */     beanFactory.registerResolvableDependency(WebRequest.class, new WebRequestObjectFactory(null));
/* 193 */     if (jsfPresent) {
...
/* 227 */       Map<String, String> parameterMap = new HashMap();
...
/* 247 */       Map<String, Object> attributeMap = new HashMap();
...
/* 292 */     if ((servletContext != null) && (propertySources.contains("servletContextInitParams")) && 
/* 293 */       ((propertySources.get("servletContextInitParams") instanceof PropertySource.StubPropertySource))) {
/* 294 */       propertySources.replace("servletContextInitParams", new ServletContextPropertySource("servletContextInitParams", servletContext));
/*     */     }
/*     */     
/* 297 */     if ((servletConfig != null) && (propertySources.contains("servletConfigInitParams")) && 
/* 298 */       ((propertySources.get("servletConfigInitParams") instanceof PropertySource.StubPropertySource))) {
/* 299 */       propertySources.replace("servletConfigInitParams", new ServletConfigPropertySource("servletConfigInitParams", servletConfig));
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 325 */       return WebApplicationContextUtils.access$400().getRequest();
/*     */     }
/*     */     
...
/*     */     {
/* 343 */       ServletResponse response = WebApplicationContextUtils.access$400().getResponse();
...
/*     */     {
/* 366 */       return WebApplicationContextUtils.access$400().getRequest().getSession();
/*     */     }
/*     */     
/*     */     public String toString()
/*     */     {
...
/*     */     {
/* 384 */       ServletRequestAttributes requestAttr = WebApplicationContextUtils.access$400();
...
/*     */     {
/* 401 */       beanFactory.registerResolvableDependency(FacesContext.class, new ObjectFactory()
/*     */       {
...
/*     */         }
/* 410 */       });
/* 411 */       beanFactory.registerResolvableDependency(ExternalContext.class, new ObjectFactory()
/*     */       {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\web\context\support\WebApplicationContextUtils.class
