...
/* 143 */     return new DefaultMultipartHttpServletRequest(request, parsingResult.getMultipartFiles(), parsingResult
...
/* 192 */     if (request != null) {
/*     */       try {
/* 194 */         cleanupFileItems(request.getMultiFileMap());
/*     */       }
/*     */       catch (Throwable ex) {
/* 197 */         this.logger.warn("Failed to perform multipart cleanup for servlet request", ex);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\web\multipart\commons\CommonsMultipartResolver.class
