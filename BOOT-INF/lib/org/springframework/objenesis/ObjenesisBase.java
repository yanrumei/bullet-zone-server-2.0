...
/*     */     }
/*  92 */     ObjectInstantiator<?> instantiator = (ObjectInstantiator)this.cache.get(clazz.getName());
/*  93 */     if (instantiator == null) {
/*  94 */       ObjectInstantiator<?> newInstantiator = this.strategy.newInstantiatorOf(clazz);
/*  95 */       instantiator = (ObjectInstantiator)this.cache.putIfAbsent(clazz.getName(), newInstantiator);
/*  96 */       if (instantiator == null) {
/*  97 */         instantiator = newInstantiator;
/*     */       }
/*     */     }
/* 100 */     return instantiator;
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\objenesis\ObjenesisBase.class
