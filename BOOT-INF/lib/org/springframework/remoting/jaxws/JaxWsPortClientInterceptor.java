...
/*  93 */   private boolean lookupServiceOnStartup = true;
/*     */   
...
/* 248 */       this.customProperties = new HashMap();
/*     */     }
...
/*     */     }
/* 351 */     WebService ann = (WebService)ifc.getAnnotation(WebService.class);
/* 352 */     if (ann != null) {
...
/*     */   {
/* 488 */     Map<String, Object> stubProperties = new HashMap();
...
/*     */     {
/* 561 */       throw new RemoteConnectFailureException("Could not connect to remote service [" + getEndpointAddress() + "]", ex);
/*     */     }
/*     */     catch (WebServiceException ex)
/*     */     {
/* 565 */       throw new RemoteAccessException("Could not access remote service at [" + getEndpointAddress() + "]", ex);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\remoting\jaxws\JaxWsPortClientInterceptor.class
