...
/* 227 */           this.logger.debug("RMI registry access threw exception", ex);
/* 228 */           this.logger.info("Could not detect RMI registry - creating new one");
/*     */           
...
/*     */       }
/*     */       catch (RemoteException ex) {
/* 264 */         this.logger.debug("RMI registry access threw exception", ex);
/* 265 */         this.logger.info("Could not detect RMI registry - creating new one");
/*     */         
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\remoting\rmi\RmiRegistryFactoryBean.class
