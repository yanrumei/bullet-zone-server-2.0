...
/*     */         {
/* 237 */           throw new RemoteLookupFailureException("Could not narrow RMI stub to service interface [" + getServiceInterface().getName() + "]", ex);
/*     */         }
/*     */       }
/* 240 */       return stub;
/*     */     }
...
/* 380 */       Object freshStub = lookupStub();
...
/*     */       catch (Throwable ex)
/*     */       {
/* 413 */         throw new RemoteInvocationFailureException("Invocation of method [" + invocation.getMethod() + "] failed in RMI service [" + getJndiName() + "]", ex);
/*     */       }
/*     */     }
/*     */     
/*     */     try
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\remoting\rmi\JndiRmiClientInterceptor.class
