...
/*     */     {
/*     */ 
/* 378 */       throw new NoHttpResponseException("Did not receive successful HTTP response: status code = " + status.getStatusCode() + ", status message = [" + status.getReasonPhrase() + "]");
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 415 */       (encodingHeader.getValue().toLowerCase().contains("gzip"));
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-web-4.3.14.RELEASE.jar!\org\springframework\remoting\httpinvoker\HttpComponentsHttpInvokerRequestExecutor.class
