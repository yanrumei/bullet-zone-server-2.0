...
/*     */     
/*  54 */     for (Map.Entry<String, Object> entry : result.entrySet()) {
/*     */       try {
...
/*  74 */           Object[] convArray = classValuesAsString ? new String[array.length] : new Class[array.length];
/*     */           
/*  76 */           for (int i = 0; i < array.length; i++)
/*     */           {
/*  78 */             convArray[i] = (classValuesAsString ? array[i].getClassName() : classLoader.loadClass(array[i].getClassName()));
/*     */           }
/*  80 */           value = convArray;
/*     */         }
...
/*     */ 
/*     */ 
/* 135 */     AnnotationAttributes result = new AnnotationAttributes((AnnotationAttributes)attributesList.get(0));
/*     */     
...
/* 152 */         Set<String> metaAnns = (Set)metaAnnotationMap.get(currentAnnotationType);
/* 153 */         if ((metaAnns != null) && (metaAnns.contains(annotationName))) {
/* 154 */           currentAttributes = (AnnotationAttributes)currentAttributesList.get(0);
...
/*     */       }
/*     */     }
/*     */     AnnotationAttributes currentAttributes;
/* 167 */     return result;
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\type\classreading\AnnotationReadingVisitorUtils.class
