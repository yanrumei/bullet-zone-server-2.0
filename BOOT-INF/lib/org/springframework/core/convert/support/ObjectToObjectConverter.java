...
/* 131 */     Member member = (Member)conversionMemberCache.get(targetClass);
...
/* 154 */       return 
/* 155 */         method
/* 156 */         .getParameterTypes()[0] == sourceClass ? true : !Modifier.isStatic(method.getModifiers()) ? ClassUtils.isAssignable(method.getDeclaringClass(), sourceClass) : false;
/*     */     }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\convert\support\ObjectToObjectConverter.class
