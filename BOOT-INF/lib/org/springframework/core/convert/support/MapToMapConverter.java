...
/*  66 */       return null;
/*     */     }
/*  68 */     Map<Object, Object> sourceMap = (Map)source;
/*     */     
/*     */ 
...
/*     */     
/*  78 */     List<MapEntry> targetEntries = new ArrayList(sourceMap.size());
/*  79 */     for (Iterator localIterator = sourceMap.entrySet().iterator(); localIterator.hasNext();) { entry = (Map.Entry)localIterator.next();
...
/*     */     }
/*     */     
/*  93 */     Object targetMap = CollectionFactory.createMap(targetType.getType(), keyDesc != null ? keyDesc
/*  94 */       .getType() : null, sourceMap.size());
/*     */     
/*  96 */     for (MapEntry entry : targetEntries) {
/*  97 */       entry.addToMap((Map)targetMap);
/*     */     }
/*  99 */     return targetMap;
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\convert\support\MapToMapConverter.class
