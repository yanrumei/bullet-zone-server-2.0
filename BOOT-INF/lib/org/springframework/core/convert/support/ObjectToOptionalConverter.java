...
/*    */   {
/* 52 */     Set<GenericConverter.ConvertiblePair> convertibleTypes = new LinkedHashSet(4);
...
/* 79 */       if ((target == null) || ((target.getClass().isArray()) && (Array.getLength(target) == 0)) || (((target instanceof Collection)) && 
/* 80 */         (((Collection)target).isEmpty()))) {
...
/*    */     {
/* 95 */       super(null, typeDescriptor.getAnnotations());
/*    */     }
/*    */   }
/*    */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\convert\support\ObjectToOptionalConverter.class
