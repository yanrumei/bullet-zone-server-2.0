...
/*     */   
/*     */   static {
/*  46 */     Set<GenericConverter.ConvertiblePair> convertiblePairs = new HashSet(4);
...
/*  78 */     return (targetType.isAssignableTo(BYTE_ARRAY_TYPE)) || 
/*  79 */       (this.conversionService.canConvert(BYTE_ARRAY_TYPE, targetType));
/*     */   }
/*     */   
/*     */   private boolean matchesToByteBuffer(TypeDescriptor sourceType) {
/*  83 */     return (sourceType.isAssignableTo(BYTE_ARRAY_TYPE)) || 
/*  84 */       (this.conversionService.canConvert(sourceType, BYTE_ARRAY_TYPE));
/*     */   }
/*     */   
...
/*     */   {
/* 113 */     byte[] bytes = (byte[])((source instanceof byte[]) ? source : this.conversionService.convert(source, sourceType, BYTE_ARRAY_TYPE));
/*     */     
/* 115 */     if (bytes == null) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\convert\support\ByteBufferConverter.class
