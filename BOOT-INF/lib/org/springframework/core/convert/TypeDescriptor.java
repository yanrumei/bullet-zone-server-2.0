...
/*  55 */     .getClassLoader());
/*     */   
/*  57 */   private static final Map<Class<?>, TypeDescriptor> commonTypesCache = new HashMap(18);
/*     */   
/*  59 */   private static final Class<?>[] CACHED_COMMON_TYPES = { Boolean.TYPE, Boolean.class, Byte.TYPE, Byte.class, Character.TYPE, Character.class, Double.TYPE, Double.class, Integer.TYPE, Integer.class, Long.TYPE, Long.class, Float.TYPE, Float.class, Short.TYPE, Short.class, String.class, Object.class };
...
/*     */     
/*  88 */     this.annotatedElement = new AnnotatedElementAdapter(methodParameter.getParameterIndex() == -1 ? methodParameter.getMethodAnnotations() : methodParameter.getParameterAnnotations());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 261 */       return null;
/*     */     }
/* 263 */     return AnnotatedElementUtils.getMergedAnnotation(this.annotatedElement, annotationType);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     }
/* 542 */     TypeDescriptor desc = (TypeDescriptor)commonTypesCache.get(type);
...
/* 759 */       return ObjectUtils.isEmpty(this.annotations);
/*     */     }
/*     */     
/*     */     public boolean equals(Object other)
/*     */     {
/* 764 */       return (this == other) || (((other instanceof AnnotatedElementAdapter)) && 
/* 765 */         (Arrays.equals(this.annotations, ((AnnotatedElementAdapter)other).annotations)));
/*     */     }
/*     */     
/*     */     public int hashCode()
/*     */     {
/* 770 */       return Arrays.hashCode(this.annotations);
/*     */     }
/*     */     
/*     */     public String toString()
/*     */     {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\convert\TypeDescriptor.class
