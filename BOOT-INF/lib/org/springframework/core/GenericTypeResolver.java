...
/*     */ {
/*  47 */   private static final Map<Class<?>, Map<TypeVariable, Type>> typeVariableCache = new ConcurrentReferenceHashMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     {
/* 228 */       throw new IllegalArgumentException("Expected 1 type argument on generic interface [" + resolvableType + "] but found " + resolvableType.getGenerics().length);
/*     */     }
...
/*     */   {
/* 271 */     Map<TypeVariable, Type> typeVariableMap = (Map)typeVariableCache.get(clazz);
/* 272 */     if (typeVariableMap == null) {
/* 273 */       typeVariableMap = new HashMap();
...
/* 284 */         variables = type.resolve().getTypeParameters();
/* 285 */         for (i = 0; i < variables.length; i++) {
/* 286 */           generic = type.getGeneric(new int[] { i });
...
/* 296 */       TypeVariable<?>[] variables = type.getInterfaces();int i = variables.length; for (ResolvableType generic = 0; generic < i; generic++) { ResolvableType interfaceType = variables[generic];
...
/*     */     {
/* 317 */       Type type = (Type)this.typeVariableMap.get(variable);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\GenericTypeResolver.class
