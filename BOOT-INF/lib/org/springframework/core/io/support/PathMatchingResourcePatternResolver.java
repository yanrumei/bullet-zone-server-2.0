...
/*     */     }
/* 320 */     return (Resource[])result.toArray(new Resource[result.size()]);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 331 */     Set<Resource> result = new LinkedHashSet(16);
...
/* 335 */       URL url = (URL)resourceUrls.nextElement();
...
/*     */   {
/* 355 */     return new UrlResource(url);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 461 */       return false;
/*     */     }
/* 463 */     String duplicatePath = "/" + filePath;
/*     */     try {
...
/* 489 */     Set<Resource> result = new LinkedHashSet(16);
/* 490 */     for (Resource rootDirResource : rootDirResources) {
/* 491 */       rootDirResource = resolveRootDirResource(rootDirResource);
...
/* 496 */         rootDirResource = new UrlResource(rootDirUrl);
/*     */       }
/*     */       
...
/*     */       }
/* 502 */       else if ((ResourceUtils.isJarURL(rootDirUrl)) || (isJarResource(rootDirResource))) {
/* 503 */         result.addAll(doFindPathMatchingJarResources(rootDirResource, rootDirUrl, subPattern));
/*     */       }
/*     */       else {
/* 506 */         result.addAll(doFindPathMatchingFileResources(rootDirResource, subPattern));
/*     */       }
/*     */     }
/* 509 */     if (logger.isDebugEnabled()) {
/* 510 */       logger.debug("Resolved location pattern [" + locationPattern + "] to resources " + result);
/*     */     }
/* 512 */     return (Resource[])result.toArray(new Resource[result.size()]);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 601 */       JarFile jarFile = jarCon.getJarFile();
/* 602 */       String jarFileUrl = jarCon.getJarFileURL().toExternalForm();
/* 603 */       JarEntry jarEntry = jarCon.getJarEntry();
/* 604 */       String rootEntryPath = jarEntry != null ? jarEntry.getName() : "";
...
/*     */         JarFile jarFile;
/* 618 */         String rootEntryPath; if (separatorIndex != -1) {
/* 619 */           String jarFileUrl = urlFile.substring(0, separatorIndex);
/* 620 */           String rootEntryPath = urlFile.substring(separatorIndex + 2);
/* 621 */           jarFile = getJarFile(jarFileUrl);
/*     */         }
/*     */         else {
/* 624 */           JarFile jarFile = new JarFile(urlFile);
/* 625 */           String jarFileUrl = urlFile;
/* 626 */           rootEntryPath = "";
/*     */         }
...
/*     */       }
/* 647 */       result = new LinkedHashSet(8);
/* 648 */       for (Enumeration<JarEntry> entries = jarFile.entries(); entries.hasMoreElements();) {
/* 649 */         JarEntry entry = (JarEntry)entries.nextElement();
...
/* 744 */     Set<Resource> result = new LinkedHashSet(matchingFiles.size());
...
/* 787 */     Set<File> result = new LinkedHashSet(8);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\io\support\PathMatchingResourcePatternResolver.class
