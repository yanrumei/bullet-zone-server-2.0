...
/*     */     
/*     */ 
/*  64 */     List<Method> candidateMethods = new ArrayList();
...
/*  74 */       return (Method)candidateMethods.get(0);
/*     */     }
/*     */     
/*     */ 
...
/*     */   {
/*  97 */     return (!candidateMethod.isBridge()) && (!candidateMethod.equals(bridgeMethod)) && 
/*  98 */       (candidateMethod.getName().equals(bridgeMethod.getName())) && 
/*  99 */       (candidateMethod.getParameterTypes().length == bridgeMethod.getParameterTypes().length);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       {
/* 120 */         sameSig = (sameSig) && (Arrays.equals(candidateMethod.getGenericParameterTypes(), previousMethod.getGenericParameterTypes()));
/*     */       }
/* 122 */       previousMethod = candidateMethod;
/*     */     }
/* 124 */     return sameSig ? (Method)candidateMethods.get(0) : null;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 227 */       return true;
/*     */     }
/* 229 */     return (Arrays.equals(bridgeMethod.getParameterTypes(), bridgedMethod.getParameterTypes())) && 
/* 230 */       (bridgeMethod.getReturnType().equals(bridgedMethod.getReturnType()));
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframework\core\BridgeMethodResolver.class
