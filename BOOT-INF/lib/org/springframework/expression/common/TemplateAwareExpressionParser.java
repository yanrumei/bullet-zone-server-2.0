...
/*     */     throws ParseException
/*     */   {
/* 111 */     List<Expression> expressions = new LinkedList();
...
/*     */         {
/*     */ 
/* 128 */           throw new ParseException(expressionString, prefixIndex, "No ending suffix '" + suffix + "' for expression starting at character " + prefixIndex + ": " + expressionString.substring(prefixIndex));
/*     */         }
...
/*     */     }
/*     */     
/* 152 */     return (Expression[])expressions.toArray(new Expression[expressions.size()]);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 195 */       return -1;
/*     */     }
/* 197 */     Stack<Bracket> stack = new Stack();
...
/*     */         {
/*     */ 
/* 215 */           throw new ParseException(expressionString, pos, "Found closing '" + ch + "' at position " + pos + " without an opening '" + Bracket.theOpenBracketFor(ch) + "'");
/*     */         }
/* 217 */         Bracket p = (Bracket)stack.pop();
...
/* 238 */       Bracket p = (Bracket)stack.pop();
/*     */       
/* 240 */       throw new ParseException(expressionString, p.pos, "Missing closing '" + Bracket.theCloseBracketFor(p.bracket) + "' for '" + p.bracket + "' at position " + p.pos);
/*     */     }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-expression-4.3.14.RELEASE.jar!\org\springframework\expression\common\TemplateAwareExpressionParser.class
