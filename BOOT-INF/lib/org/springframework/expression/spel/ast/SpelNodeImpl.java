...
/* 100 */       int i = 0; for (int max = peers.length; i < max; i++) {
/* 101 */         if (this == peers[i]) {
/* 102 */           if (i + 1 >= max) {
/* 103 */             return false;
/*     */           }
...
/*     */     
/*     */ 
/* 125 */     return getValue(new ExpressionState(new StandardEvaluationContext()));
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/* 136 */     return getTypedValue(new ExpressionState(new StandardEvaluationContext()));
/*     */   }
/*     */   
/*     */ 
...
/*     */     throws EvaluationException
/*     */   {
/* 149 */     throw new SpelEvaluationException(getStartPosition(), SpelMessage.SETVALUE_NOT_SUPPORTED, new Object[] {getClass() });
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-expression-4.3.14.RELEASE.jar!\org\springframework\expression\spel\ast\SpelNodeImpl.class
