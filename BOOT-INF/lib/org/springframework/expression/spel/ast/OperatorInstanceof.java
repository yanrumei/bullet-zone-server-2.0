...
/*     */     {
/*     */ 
/*  65 */       throw new SpelEvaluationException(getRightOperand().getStartPosition(), SpelMessage.INSTANCEOF_OPERATOR_NEEDS_CLASS_OPERAND, new Object[] { rightValue == null ? "null" : rightValue.getClass().getName() });
/*     */     }
/*  67 */     Class<?> rightClass = (Class)rightValue;
/*  68 */     BooleanTypedValue result; BooleanTypedValue result; if (leftValue == null) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-expression-4.3.14.RELEASE.jar!\org\springframework\expression\spel\ast\OperatorInstanceof.class
