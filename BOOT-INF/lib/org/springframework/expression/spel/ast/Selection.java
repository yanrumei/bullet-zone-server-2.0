...
/*     */     Object val;
/*  80 */     Object resultMap; if ((operand instanceof Map)) {
/*  81 */       Map<?, ?> mapdata = (Map)operand;
/*     */       
/*  83 */       Map<Object, Object> result = new HashMap();
...
/*  90 */           state.enterScope();
/*  91 */           val = selectionCriteria.getValueInternal(state).getValue();
...
/* 118 */         resultMap = new HashMap();
/* 119 */         Object lastValue = result.get(lastKey);
/* 120 */         ((Map)resultMap).put(lastKey, lastValue);
...
/* 132 */       int index = 0;
/* 133 */       for (resultMap = data.iterator(); ((Iterator)resultMap).hasNext();) { Object element = ((Iterator)resultMap).next();
/*     */         try {
...
/*     */       }
/*     */       
/* 170 */       Object elementType = ClassUtils.resolvePrimitiveIfNecessary(op
/* 171 */         .getTypeDescriptor().getElementTypeDescriptor().getType());
/* 172 */       Object resultArray = Array.newInstance((Class)elementType, result.size());
...
/*     */     }
/*     */     
/* 183 */     throw new SpelEvaluationException(getStartPosition(), SpelMessage.INVALID_TYPE_FOR_SELECTION, new Object[] {operand.getClass().getName() });
/*     */   }
/*     */   
...
/*     */     }
/*     */     
/* 200 */     return getChild(0).toStringAST() + "]";
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-expression-4.3.14.RELEASE.jar!\org\springframework\expression\spel\ast\Selection.class
