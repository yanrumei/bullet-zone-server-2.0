...
/*     */       {
/*  70 */         throw new ApplicationContextException("Invalid application context: needs to be of type [" + requiredContextClass().getName() + "]");
/*     */       }
/*  72 */       this.applicationContext = context;
/*  73 */       this.messageSourceAccessor = new MessageSourceAccessor(context);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\context\support\ApplicationObjectSupport.class
