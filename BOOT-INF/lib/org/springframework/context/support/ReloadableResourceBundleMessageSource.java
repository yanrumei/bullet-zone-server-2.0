...
/*  97 */   private boolean concurrentRefresh = true;
/*     */   
/*  99 */   private PropertiesPersister propertiesPersister = new DefaultPropertiesPersister();
/*     */   
/* 101 */   private ResourceLoader resourceLoader = new DefaultResourceLoader();
/*     */   
/*     */ 
/* 104 */   private final ConcurrentMap<String, Map<Locale, List<String>>> cachedFilenames = new ConcurrentHashMap();
/*     */   
/*     */ 
/*     */ 
/* 108 */   private final ConcurrentMap<String, PropertiesHolder> cachedProperties = new ConcurrentHashMap();
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 151 */     this.propertiesPersister = (propertiesPersister != null ? propertiesPersister : new DefaultPropertiesPersister());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 177 */       propHolder = getMergedProperties(locale);
...
/* 246 */         String filename = (String)filenames.get(j);
...
/* 257 */     PropertiesHolder existing = (PropertiesHolder)this.cachedMergedProperties.putIfAbsent(locale, mergedHolder);
...
/*     */   {
/* 275 */     Map<Locale, List<String>> localeMap = (Map)this.cachedFilenames.get(basename);
/* 276 */     if (localeMap != null) {
/* 277 */       List<String> filenames = (List)localeMap.get(locale);
...
/* 296 */       Map<Locale, List<String>> existing = (Map)this.cachedFilenames.putIfAbsent(basename, localeMap);
...
/*     */   {
/* 350 */     PropertiesHolder propHolder = (PropertiesHolder)this.cachedProperties.get(filename);
...
/* 362 */       PropertiesHolder existingHolder = (PropertiesHolder)this.cachedProperties.putIfAbsent(filename, propHolder);
...
/*     */     }
/*     */     try {
/* 381 */       PropertiesHolder existingHolder = (PropertiesHolder)this.cachedProperties.get(filename);
/* 382 */       PropertiesHolder localPropertiesHolder1; if ((existingHolder != null) && (existingHolder.getRefreshTimestamp() > originalTimestamp)) {
...
/*     */     
/*     */ 
/* 560 */     private final ConcurrentMap<String, Map<Locale, MessageFormat>> cachedMessageFormats = new ConcurrentHashMap();
/*     */     
...
/* 598 */         return null;
/*     */       }
/* 600 */       Map<Locale, MessageFormat> localeMap = (Map)this.cachedMessageFormats.get(code);
/* 601 */       if (localeMap != null) {
/* 602 */         MessageFormat result = (MessageFormat)localeMap.get(locale);
/* 603 */         if (result != null) {
/* 604 */           return result;
/*     */         }
/*     */       }
...
/* 610 */           localeMap = new ConcurrentHashMap();
/* 611 */           Map<Locale, MessageFormat> existing = (Map)this.cachedMessageFormats.putIfAbsent(code, localeMap);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\context\support\ReloadableResourceBundleMessageSource.class
