...
/* 270 */     Set<BeanDefinitionHolder> beanDefinitions = new LinkedHashSet();
...
/*     */     
/*     */ 
/* 345 */     throw new ConflictingBeanDefinitionException("Annotation-specified bean name '" + beanName + "' for bean class [" + beanDefinition.getBeanClassName() + "] conflicts with existing, non-compatible bean definition of same name and class [" + existingDef.getBeanClassName() + "]");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 360 */     return (!(existingDefinition instanceof ScannedGenericBeanDefinition)) || 
/* 361 */       (newDefinition.getSource().equals(existingDefinition.getSource())) || 
/* 362 */       (newDefinition.equals(existingDefinition));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\context\annotation\ClassPathBeanDefinitionScanner.class
