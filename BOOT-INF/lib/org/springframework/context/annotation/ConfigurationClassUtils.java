...
/*     */   
/*  62 */   private static final Set<String> candidateIndicators = new HashSet(4);
/*     */   
/*     */   static {
...
/*  87 */     if (((beanDef instanceof AnnotatedBeanDefinition)) && 
/*  88 */       (className.equals(((AnnotatedBeanDefinition)beanDef).getMetadata().getClassName())))
/*     */     {
/*  90 */       metadata = ((AnnotatedBeanDefinition)beanDef).getMetadata();
/*     */     } else { AnnotationMetadata metadata;
/*  92 */       if (((beanDef instanceof AbstractBeanDefinition)) && (((AbstractBeanDefinition)beanDef).hasBeanClass()))
/*     */       {
/*     */ 
/*  95 */         Class<?> beanClass = ((AbstractBeanDefinition)beanDef).getBeanClass();
/*  96 */         metadata = new StandardAnnotationMetadata(beanClass, true);
/*     */       }
/*     */       else {
/*     */         try {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\context\annotation\ConfigurationClassUtils.class
