...
/* 235 */       return new AnnotationTypeFilter(ClassUtils.forName(expression, classLoader));
/*     */     }
...
/*     */       {
/* 250 */         throw new IllegalArgumentException("Class is not assignable to [" + TypeFilter.class.getName() + "]: " + expression);
/*     */       }
...
/*     */     catch (ClassNotFoundException ex) {
/*     */       Object result;
/* 267 */       throw new IllegalArgumentException("Class [" + className + "] for strategy [" + strategyType.getName() + "] not found", ex);
/*     */     }
/*     */     catch (Throwable ex)
/*     */     {
/* 271 */       throw new IllegalArgumentException("Unable to instantiate class [" + className + "] for strategy [" + strategyType.getName() + "]: a zero-argument constructor is required", ex);
/*     */     }
/*     */     Object result;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\context\annotation\ComponentScanBeanDefinitionParser.class
