...
/*     */ {
/*  46 */   private static final ThreadLocal<LocaleContext> localeContextHolder = new NamedThreadLocal("LocaleContext");
/*     */   
/*     */ 
/*  49 */   private static final ThreadLocal<LocaleContext> inheritableLocaleContextHolder = new NamedInheritableThreadLocal("LocaleContext");
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 113 */     LocaleContext localeContext = (LocaleContext)localeContextHolder.get();
/* 114 */     if (localeContext == null) {
/* 115 */       localeContext = (LocaleContext)inheritableLocaleContextHolder.get();
/*     */     }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\context\i18n\LocaleContextHolder.class
