...
/*     */     {
/* 105 */       throw new IllegalStateException("ClassLoader [" + classLoader.getClass().getName() + "] does NOT provide an 'addTransformer(ClassFileTransformer)' method.");
/*     */     }
/*     */     
...
/* 136 */       return (target instanceof DecoratingClassLoader) ? target : new OverridingClassLoader(this.classLoader, target);
/*     */     }
/*     */     
/*     */ 
/* 140 */     return new SimpleThrowawayClassLoader(this.classLoader);
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\instrument\classloading\ReflectiveLoadTimeWeaver.class
