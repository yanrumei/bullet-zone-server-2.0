...
/*     */     try
/*     */     {
/*  62 */       Class<?> wsCompoundClassLoaderClass = classLoader.loadClass("com.ibm.ws.classloader.CompoundClassLoader");
/*  63 */       this.cloneConstructor = classLoader.getClass().getDeclaredConstructor(new Class[] { wsCompoundClassLoaderClass });
...
/*     */     try {
/* 105 */       ClassLoader loader = (ClassLoader)this.cloneConstructor.newInstance(new Object[] { getClassLoader() });
/*     */       
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\instrument\classloading\websphere\WebSphereClassLoaderAdapter.class
