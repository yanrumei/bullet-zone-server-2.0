...
/*     */   {
/*  62 */     return configureFormatterFrom(annotation);
/*     */   }
/*     */   
/*     */   public Parser<MonetaryAmount> getParser(NumberFormat annotation, Class<?> fieldType)
/*     */   {
/*  67 */     return configureFormatterFrom(annotation);
/*     */   }
/*     */   
...
/*  78 */       return new NumberDecoratingFormatter(new NumberStyleFormatter());
/*     */     }
/*  80 */     if (style == NumberFormat.Style.PERCENT) {
/*  81 */       return new NumberDecoratingFormatter(new PercentStyleFormatter());
/*     */     }
/*     */     
/*  84 */     return new NumberDecoratingFormatter(new CurrencyStyleFormatter());
/*     */   }
/*     */   
/*     */ 
