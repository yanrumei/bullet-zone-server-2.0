...
/*  57 */   private Map<String, Object> environment = new HashMap();
/*     */   
/*  59 */   private boolean connectOnStartup = true;
/*     */   
...
/*     */     
/*     */ 
/* 145 */     this.connector = ((JMXConnector)new ProxyFactory(JMXConnector.class, this.connectorTargetSource).getProxy(this.beanClassLoader));
/*     */     
/* 147 */     this.connection = ((MBeanServerConnection)new ProxyFactory(MBeanServerConnection.class, connectionTargetSource).getProxy(this.beanClassLoader));
/*     */   }
/*     */   
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\jmx\support\MBeanServerConnectionFactoryBean.class
