...
/*     */         {
/*  87 */           throw new IllegalArgumentException("Management interface [" + ifc.getName() + "] is not an interface");
/*     */         }
/*     */       }
/*     */     }
...
/*     */   {
/* 124 */     Map<String, Class<?>[]> resolvedMappings = new HashMap(mappings.size());
...
/* 216 */       ifaces = (Class[])this.resolvedInterfaceMappings.get(beanKey);
/*     */     }
/*     */     
/* 219 */     if (ifaces == null) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\jmx\export\assembler\InterfaceBasedMBeanInfoAssembler.class
