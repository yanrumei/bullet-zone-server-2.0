...
/*     */       {
/* 157 */         throw new ScriptCompilationException(scriptSource, "Unable to instantiate script class: " + scriptClass.getName(), ex);
/*     */       }
/*     */       catch (IllegalAccessException ex)
/*     */       {
/* 161 */         throw new ScriptCompilationException(scriptSource, "Could not access script constructor: " + scriptClass.getName(), ex);
/*     */       }
/*     */     }
/*     */     
/* 165 */     return script;
...
/*     */   }
/*     */   
/*     */   protected Object adaptToInterfaces(Object script, ScriptSource scriptSource, Class<?>... actualInterfaces) { Class<?> adaptedIfc;
/*     */     Class<?> adaptedIfc;
...
/* 227 */         if (script == null)
/*     */         {
/* 229 */           throw new ScriptCompilationException(scriptSource, "Could not adapt script to interface [" + adaptedIfc.getName() + "]");
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-context-4.3.14.RELEASE.jar!\org\springframework\scripting\support\StandardScriptFactory.class
