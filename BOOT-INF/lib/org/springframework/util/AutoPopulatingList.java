...
/*     */   {
/*  63 */     this(new ArrayList(), elementClass);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  72 */     this(backingList, new ReflectiveElementFactory(elementClass));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  80 */     this(new ArrayList(), elementFactory);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 187 */     return (E)this.backingList.remove(index);
/*     */   }
/*     */   
...
/*     */   {
/* 207 */     return (E)this.backingList.set(index, element);
/*     */   }
/*     */   
/*     */   public int size()
/*     */   {
...
/*     */ 
/*     */ 
/*     */   public static abstract interface ElementFactory<E>
/*     */   {
/*     */     public abstract E createElement(int paramInt)
...
/*     */     implements AutoPopulatingList.ElementFactory<E>, Serializable
/*     */   {
...
/*     */     {
/*     */       try {
/* 291 */         return (E)this.elementClass.newInstance();
/*     */       }
/*     */       catch (InstantiationException ex)
/*     */       {
/* 295 */         throw new AutoPopulatingList.ElementInstantiationException("Unable to instantiate element class: " + this.elementClass.getName(), ex);
/*     */       }
/*     */       catch (IllegalAccessException ex)
/*     */       {
/* 299 */         throw new AutoPopulatingList.ElementInstantiationException("Could not access element constructor: " + this.elementClass.getName(), ex);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\AutoPopulatingList.class
