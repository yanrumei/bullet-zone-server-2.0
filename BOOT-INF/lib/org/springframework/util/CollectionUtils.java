...
/*     */   {
/* 321 */     ArrayList<A> elements = new ArrayList();
...
/*     */   {
/* 344 */     return new MultiValueMapAdapter(map);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 356 */     Map<K, List<V>> result = new LinkedHashMap(map.size());
/* 357 */     for (Map.Entry<? extends K, ? extends List<? extends V>> entry : map.entrySet()) {
/* 358 */       List<? extends V> values = Collections.unmodifiableList((List)entry.getValue());
/* 359 */       result.put(entry.getKey(), values);
/*     */     }
/* 361 */     Object unmodifiableMap = Collections.unmodifiableMap(result);
/* 362 */     return toMultiValueMap((Map)unmodifiableMap);
/*     */   }
/*     */   
/*     */ 
...
/*     */     public E next()
/*     */     {
/* 384 */       return (E)this.enumeration.nextElement();
/*     */     }
/*     */     
...
/*     */     {
/* 409 */       List<V> values = (List)this.map.get(key);
/* 410 */       if (values == null) {
/* 411 */         values = new LinkedList();
...
/*     */     {
/* 419 */       List<V> values = (List)this.map.get(key);
/* 420 */       return (V)(values != null ? values.get(0) : null);
/*     */     }
/*     */     
/*     */     public void set(K key, V value)
/*     */     {
/* 425 */       List<V> values = new LinkedList();
...
/*     */     {
/* 439 */       LinkedHashMap<K, V> singleValueMap = new LinkedHashMap(this.map.size());
/* 440 */       for (Map.Entry<K, List<V>> entry : this.map.entrySet()) {
/* 441 */         singleValueMap.put(entry.getKey(), ((List)entry.getValue()).get(0));
/*     */       }
...
/*     */     {
/* 468 */       return (List)this.map.get(key);
/*     */     }
/*     */     
/*     */     public List<V> put(K key, List<V> value)
/*     */     {
/* 473 */       return (List)this.map.put(key, value);
/*     */     }
/*     */     
/*     */     public List<V> remove(Object key)
/*     */     {
/* 478 */       return (List)this.map.remove(key);
/*     */     }
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\CollectionUtils.class
