...
/*     */   {
/*  88 */     this.targetMap = new LinkedHashMap(initialCapacity)
/*     */     {
...
/*  96 */         if (doRemove) {
/*  97 */           LinkedCaseInsensitiveMap.this.caseInsensitiveKeys.remove(LinkedCaseInsensitiveMap.this.convertKey((String)eldest.getKey()));
/*     */         }
/*  99 */         return doRemove;
/*     */       }
/* 101 */     };
/* 102 */     this.caseInsensitiveKeys = new HashMap(initialCapacity);
...
/*     */   {
/* 111 */     this.targetMap = ((LinkedHashMap)other.targetMap.clone());
/* 112 */     this.caseInsensitiveKeys = ((HashMap)other.caseInsensitiveKeys.clone());
...
/* 142 */       String caseInsensitiveKey = (String)this.caseInsensitiveKeys.get(convertKey((String)key));
/* 143 */       if (caseInsensitiveKey != null) {
/* 144 */         return (V)this.targetMap.get(caseInsensitiveKey);
/*     */       }
/*     */     }
/* 147 */     return null;
/*     */   }
...
/* 153 */       String caseInsensitiveKey = (String)this.caseInsensitiveKeys.get(convertKey((String)key));
/* 154 */       if (caseInsensitiveKey != null) {
/* 155 */         return (V)this.targetMap.get(caseInsensitiveKey);
/*     */       }
/*     */     }
...
/*     */   {
/* 163 */     String oldKey = (String)this.caseInsensitiveKeys.put(convertKey(key), key);
/* 164 */     if ((oldKey != null) && (!oldKey.equals(key))) {
/* 165 */       this.targetMap.remove(oldKey);
/*     */     }
/* 167 */     return (V)this.targetMap.put(key, value);
/*     */   }
/*     */   
...
/* 176 */       put((String)entry.getKey(), entry.getValue());
/*     */     }
/*     */   }
/*     */   
...
/* 183 */       String caseInsensitiveKey = (String)this.caseInsensitiveKeys.remove(convertKey((String)key));
/* 184 */       if (caseInsensitiveKey != null) {
/* 185 */         return (V)this.targetMap.remove(caseInsensitiveKey);
/*     */       }
/*     */     }
/* 188 */     return null;
/*     */   }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\LinkedCaseInsensitiveMap.class
