...
/*     */   static
/*     */   {
/*  50 */     Set<Class<?>> numberTypes = new HashSet(8);
...
/*     */       }
/*  94 */       return Byte.valueOf(number.byteValue());
/*     */     }
...
/*     */       }
/* 101 */       return Short.valueOf(number.shortValue());
/*     */     }
...
/*     */       }
/* 108 */       return Integer.valueOf(number.intValue());
/*     */     }
/* 110 */     if (Long.class == targetClass) {
/* 111 */       long value = checkedLongValue(number, targetClass);
/* 112 */       return Long.valueOf(value);
/*     */     }
/* 114 */     if (BigInteger.class == targetClass) {
/* 115 */       if ((number instanceof BigDecimal))
/*     */       {
/* 117 */         return ((BigDecimal)number).toBigInteger();
/*     */       }
/*     */       
/*     */ 
/* 121 */       return BigInteger.valueOf(number.longValue());
/*     */     }
/*     */     
/* 124 */     if (Float.class == targetClass) {
/* 125 */       return Float.valueOf(number.floatValue());
/*     */     }
/* 127 */     if (Double.class == targetClass) {
/* 128 */       return Double.valueOf(number.doubleValue());
/*     */     }
/* 130 */     if (BigDecimal.class == targetClass)
/*     */     {
/*     */ 
/* 133 */       return new BigDecimal(number.toString());
/*     */     }
/*     */     
/*     */ 
/* 137 */     throw new IllegalArgumentException("Could not convert number [" + number + "] of type [" + number.getClass().getName() + "] to unsupported target class [" + targetClass.getName() + "]");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 173 */     throw new IllegalArgumentException("Could not convert number [" + number + "] of type [" + number.getClass().getName() + "] to target class [" + targetClass.getName() + "]: overflow");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 202 */       return isHexNumber(trimmed) ? Byte.decode(trimmed) : Byte.valueOf(trimmed);
/*     */     }
/* 204 */     if (Short.class == targetClass) {
/* 205 */       return isHexNumber(trimmed) ? Short.decode(trimmed) : Short.valueOf(trimmed);
/*     */     }
/* 207 */     if (Integer.class == targetClass) {
/* 208 */       return isHexNumber(trimmed) ? Integer.decode(trimmed) : Integer.valueOf(trimmed);
/*     */     }
/* 210 */     if (Long.class == targetClass) {
/* 211 */       return isHexNumber(trimmed) ? Long.decode(trimmed) : Long.valueOf(trimmed);
/*     */     }
/* 213 */     if (BigInteger.class == targetClass) {
/* 214 */       return isHexNumber(trimmed) ? decodeBigInteger(trimmed) : new BigInteger(trimmed);
/*     */     }
/* 216 */     if (Float.class == targetClass) {
/* 217 */       return Float.valueOf(trimmed);
/*     */     }
/* 219 */     if (Double.class == targetClass) {
/* 220 */       return Double.valueOf(trimmed);
/*     */     }
/* 222 */     if ((BigDecimal.class == targetClass) || (Number.class == targetClass)) {
/* 223 */       return new BigDecimal(trimmed);
/*     */     }
/*     */     
/*     */ 
/* 227 */     throw new IllegalArgumentException("Cannot convert String [" + text + "] to target class [" + targetClass.getName() + "]");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\NumberUtils.class
