...
/*     */   {
/*  70 */     this.targetMap = new LinkedHashMap(otherMap);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  78 */     List<V> values = (List)this.targetMap.get(key);
/*  79 */     if (values == null) {
/*  80 */       values = new LinkedList();
...
/*     */   {
/*  88 */     List<V> values = (List)this.targetMap.get(key);
/*  89 */     return (V)(values != null ? values.get(0) : null);
/*     */   }
/*     */   
/*     */   public void set(K key, V value)
/*     */   {
/*  94 */     List<V> values = new LinkedList();
/*  95 */     values.add(value);
...
/*     */   {
/* 108 */     LinkedHashMap<K, V> singleValueMap = new LinkedHashMap(this.targetMap.size());
/* 109 */     for (Map.Entry<K, List<V>> entry : this.targetMap.entrySet()) {
/* 110 */       singleValueMap.put(entry.getKey(), ((List)entry.getValue()).get(0));
/*     */     }
...
/*     */   {
/* 140 */     return (List)this.targetMap.get(key);
/*     */   }
/*     */   
/*     */   public List<V> put(K key, List<V> value)
/*     */   {
/* 145 */     return (List)this.targetMap.put(key, value);
/*     */   }
/*     */   
/*     */   public List<V> remove(Object key)
/*     */   {
/* 150 */     return (List)this.targetMap.remove(key);
/*     */   }
/*     */   
...
/* 188 */       copy.put(entry.getKey(), new LinkedList((Collection)entry.getValue()));
/*     */     }
/* 190 */     return copy;
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\LinkedMultiValueMap.class
