...
/*     */ {
/*  43 */   private final List<Map<String, String>> namespaceMappings = new ArrayList();
/*     */   
...
/* 226 */     return (("xmlns".equals(localPart)) && (prefix.isEmpty())) || (
/* 227 */       ("xmlns".equals(prefix)) && (!localPart.isEmpty()));
/*     */   }
/*     */   
/*     */   private Map<String, String> currentNamespaceMapping()
/*     */   {
/* 232 */     return (Map)this.namespaceMappings.get(this.namespaceMappings.size() - 1);
/*     */   }
/*     */   
/*     */   private void newNamespaceMapping() {
/* 236 */     this.namespaceMappings.add(new HashMap());
/*     */   }
/*     */   
...
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void startElementInternal(QName paramQName, Attributes paramAttributes, Map<String, String> paramMap)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void endElementInternal(QName paramQName, Map<String, String> paramMap)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void charactersInternal(String paramString)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void cDataInternal(String paramString)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void ignorableWhitespaceInternal(String paramString)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void processingInstructionInternal(String paramString1, String paramString2)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void skippedEntityInternal(String paramString)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void dtdInternal(String paramString)
/*     */     throws XMLStreamException;
/*     */   
/*     */   protected abstract void commentInternal(String paramString)
/*     */     throws XMLStreamException;
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\xml\AbstractStaxHandler.class
