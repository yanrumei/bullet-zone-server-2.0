...
/*     */     }
/* 195 */     int count = 0;
/* 196 */     Iterator attributes = this.event.asStartElement().getAttributes();
/* 197 */     while (attributes.hasNext()) {
/* 198 */       Attribute attribute = (Attribute)attributes.next();
/* 199 */       if (count == index) {
...
/*     */     } else { Iterator namespaces;
/* 226 */       if (this.event.isEndElement()) {
...
/*     */     } else { Iterator namespaces;
/* 251 */       if (this.event.isEndElement()) {
...
/* 259 */       Namespace namespace = (Namespace)namespaces.next();
/* 260 */       if (count == index) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\xml\XMLEventStreamReader.class
