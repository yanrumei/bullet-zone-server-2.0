...
/*  51 */   private final LinkedList<byte[]> buffers = new LinkedList();
/*     */   
/*     */ 
...
/* 196 */     return (byte[])this.buffers.getFirst();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 351 */         this.currentBuffer = ((byte[])this.buffersIterator.next());
...
/* 423 */         this.currentBuffer = ((byte[])this.buffersIterator.next());
...
/* 466 */         this.currentBuffer = ((byte[])this.buffersIterator.next());
...
/*     */     {
/* 493 */       updateMessageDigest(messageDigest, available());
/*     */     }
/*     */     
/*     */ 
/*     */ 
...
/*     */       }
/* 510 */       if (len < 0) {
/* 511 */         throw new IllegalArgumentException("len must be 0 or greater: " + len);
/*     */       }
/*     */       
/* 514 */       if (this.nextIndexInCurrentBuffer < this.currentBufferLength) {
/* 515 */         int bytesToCopy = Math.min(len, this.currentBufferLength - this.nextIndexInCurrentBuffer);
/* 516 */         messageDigest.update(this.currentBuffer, this.nextIndexInCurrentBuffer, bytesToCopy);
/* 517 */         this.nextIndexInCurrentBuffer += bytesToCopy;
/* 518 */         updateMessageDigest(messageDigest, len - bytesToCopy);
/*     */       }
/*     */       else {
/* 521 */         if (this.buffersIterator.hasNext()) {
/* 522 */           this.currentBuffer = ((byte[])this.buffersIterator.next());
/* 523 */           if (this.currentBuffer == this.fastByteArrayOutputStream.buffers.getLast()) {
/* 524 */             this.currentBufferLength = this.fastByteArrayOutputStream.index;
/*     */           }
/*     */           else {
/* 527 */             this.currentBufferLength = this.currentBuffer.length;
/*     */           }
/* 529 */           this.nextIndexInCurrentBuffer = 0;
/*     */         }
/*     */         else {
/* 532 */           this.currentBuffer = null;
/*     */         }
/* 534 */         updateMessageDigest(messageDigest, len);
/*     */       }
/*     */     }
/*     */   }
/*     */ }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\FastByteArrayOutputStream.class
