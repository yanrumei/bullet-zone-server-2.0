...
/* 270 */     return ("file".equals(protocol)) || ("vfsfile".equals(protocol)) || 
/* 271 */       ("vfs".equals(protocol));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 282 */     return ("jar".equals(protocol)) || ("war".equals(protocol)) || 
/* 283 */       ("zip".equals(protocol)) || ("vfszip".equals(protocol)) || 
/* 284 */       ("wsjar".equals(protocol));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 295 */     return ("file".equals(url.getProtocol())) && 
/* 296 */       (url.getPath().toLowerCase().endsWith(".jar"));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-core-4.3.14.RELEASE.jar!\org\springframewor\\util\ResourceUtils.class
