...
/*     */   {
/*  93 */     this.evaluations += 1;
/*     */     
/*  95 */     for (StackTraceElement element : new Throwable().getStackTrace()) {
/*  96 */       if ((element.getClassName().equals(this.clazz.getName())) && ((this.methodName == null) || 
/*  97 */         (element.getMethodName().equals(this.methodName)))) {
/*  98 */         return true;
/*     */       }
/*     */     }
/* 101 */     return false;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\support\ControlFlowPointcut.class
