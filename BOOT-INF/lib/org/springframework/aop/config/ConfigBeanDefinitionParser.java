...
/* 110 */         parsePointcut(elt, parserContext);
/*     */       }
/* 112 */       else if ("advisor".equals(localName)) {
/* 113 */         parseAdvisor(elt, parserContext);
/*     */       }
/* 115 */       else if ("aspect".equals(localName)) {
...
/* 147 */         parserContext.getRegistry().registerBeanDefinition(advisorBeanName, advisorDef);
/*     */       }
/*     */       else {
/* 150 */         advisorBeanName = parserContext.getReaderContext().registerWithGeneratedName(advisorDef);
/*     */       }
/*     */       
...
/* 156 */         parserContext.registerComponent(new AdvisorComponentDefinition(advisorBeanName, advisorDef, (BeanDefinition)pointcut));
/*     */ 
/*     */       }
...
/* 161 */         parserContext.registerComponent(new AdvisorComponentDefinition(advisorBeanName, advisorDef));
/*     */       }
/*     */     }
/*     */     finally
/*     */     {
...
/* 202 */       List<BeanDefinition> beanDefinitions = new ArrayList();
/* 203 */       List<BeanReference> beanReferences = new ArrayList();
/*     */       
...
/* 207 */         Element declareParentsElement = (Element)declareParents.get(i);
...
/* 215 */       AbstractBeanDefinition advisorDefinition; for (int i = 0; i < nodeList.getLength(); i++) {
...
/*     */           }
/* 228 */           advisorDefinition = parseAdvice(aspectName, i, aspectElement, (Element)node, parserContext, beanDefinitions, beanReferences);
/*     */           
...
/*     */   {
/* 254 */     BeanDefinition[] beanDefArray = (BeanDefinition[])beanDefs.toArray(new BeanDefinition[beanDefs.size()]);
/* 255 */     BeanReference[] beanRefArray = (BeanReference[])beanRefs.toArray(new BeanReference[beanRefs.size()]);
...
/* 271 */     return ("before".equals(name)) || ("after".equals(name)) || ("after-returning".equals(name)) || 
/* 272 */       ("after-throwing".equals(name)) || ("around".equals(name));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 303 */     parserContext.getReaderContext().registerWithGeneratedName(definition);
...
/*     */       
/*     */ 
/* 347 */       parserContext.getReaderContext().registerWithGeneratedName(advisorDefinition);
/*     */       
/* 349 */       return advisorDefinition;
/*     */     }
/*     */     finally {
...
/* 447 */         parserContext.getRegistry().registerBeanDefinition(pointcutBeanName, pointcutDefinition);
/*     */       }
/*     */       else {
/* 450 */         pointcutBeanName = parserContext.getReaderContext().registerWithGeneratedName(pointcutDefinition);
/*     */       }
/*     */       
/* 453 */       parserContext.registerComponent(new PointcutComponentDefinition(pointcutBeanName, pointcutDefinition, expression));
/*     */     }
/*     */     finally
/*     */     {
...
/* 509 */     return beanDefinition;
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\config\ConfigBeanDefinitionParser.class
