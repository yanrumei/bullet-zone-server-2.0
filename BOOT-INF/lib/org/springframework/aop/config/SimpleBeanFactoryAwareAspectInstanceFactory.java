...
/*    */   public int getOrder()
/*    */   {
/* 78 */     if ((this.beanFactory.isSingleton(this.aspectBeanName)) && 
/* 79 */       (this.beanFactory.isTypeMatch(this.aspectBeanName, Ordered.class))) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\config\SimpleBeanFactoryAwareAspectInstanceFactory.class
