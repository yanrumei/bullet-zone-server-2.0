...
/*     */ {
/*  84 */   private static final Set<PointcutPrimitive> SUPPORTED_PRIMITIVES = new HashSet();
/*     */   
/*     */   static {
...
/*     */   
/* 114 */   private transient Map<Method, ShadowMatch> shadowMatchCache = new ConcurrentHashMap(32);
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */     
/* 228 */     parser.registerPointcutDesignatorHandler(new BeanNamePointcutDesignatorHandler(null));
/* 229 */     return parser;
/*     */   }
/*     */   
/*     */ 
...
/* 369 */         logger.debug("Failed to evaluate join point for arguments " + Arrays.asList(args) + " - falling back to non-match", ex);
/*     */       }
/*     */     }
/* 372 */     return false;
/*     */   }
...
/*     */   {
/* 416 */     ShadowMatch shadowMatch = (ShadowMatch)this.shadowMatchCache.get(targetMethod);
...
/* 422 */         shadowMatch = (ShadowMatch)this.shadowMatchCache.get(targetMethod);
...
/*     */           {
/* 471 */             shadowMatch = new DefensiveShadowMatch(shadowMatch, fallbackExpression.matchesMethodExecution(methodToMatch));
/*     */           }
...
/*     */     {
/* 551 */       return new AspectJExpressionPointcut.BeanNameContextMatcher(AspectJExpressionPointcut.this, expression);
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/*     */     {
/* 575 */       return contextMatch(someClass) == org.aspectj.weaver.tools.FuzzyBoolean.YES;
/*     */     }
/*     */     
/*     */ 
/*     */     @Deprecated
...
/*     */     {
/* 582 */       return contextMatch(someClass) == org.aspectj.weaver.tools.FuzzyBoolean.YES;
/*     */     }
/*     */     
...
/*     */       {
/* 604 */         return org.aspectj.weaver.tools.FuzzyBoolean.MAYBE;
/*     */       }
/* 606 */       if (BeanFactoryUtils.isGeneratedBeanName(advisedBeanName)) {
/* 607 */         return org.aspectj.weaver.tools.FuzzyBoolean.NO;
/*     */       }
/* 609 */       if (targetType != null) {
/* 610 */         boolean isFactory = FactoryBean.class.isAssignableFrom(targetType);
/* 611 */         return org.aspectj.weaver.tools.FuzzyBoolean.fromBoolean(
/* 612 */           matchesBeanName(isFactory ? "&" + advisedBeanName : advisedBeanName));
/*     */       }
/*     */       
/* 615 */       return org.aspectj.weaver.tools.FuzzyBoolean.fromBoolean((matchesBeanName(advisedBeanName)) || 
...
/*     */ 
/*     */ 
/* 647 */     this.shadowMatchCache = new ConcurrentHashMap(32);
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\aspectj\AspectJExpressionPointcut.class
