...
/*     */   
/* 113 */   private boolean freezeProxy = false;
/*     */   
/* 115 */   private transient ClassLoader proxyClassLoader = ClassUtils.getDefaultClassLoader();
/*     */   
/* 117 */   private transient boolean classLoaderConfigured = false;
/*     */   
/*     */ 
/*     */   private transient BeanFactory beanFactory;
/*     */   
/* 122 */   private boolean advisorChainInitialized = false;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 376 */     if (!ObjectUtils.isEmpty(this.interceptorNames)) {
...
/*     */     }
/*     */     
/* 427 */     if (!ObjectUtils.isEmpty(this.interceptorNames)) {
/* 428 */       if (this.beanFactory == null)
/*     */       {
/* 430 */         throw new IllegalStateException("No BeanFactory available anymore (probably due to serialization) - cannot resolve interceptor names " + Arrays.asList(this.interceptorNames));
/*     */       }
/*     */       
/*     */ 
...
/* 483 */     List<Advisor> freshAdvisors = new ArrayList(advisors.length);
...
/*     */         {
/* 494 */           throw new IllegalStateException("No BeanFactory available anymore (probably due to serialization) - cannot resolve prototype advisor '" + pa.getBeanName() + "'");
/*     */         }
...
/* 517 */     Map<Object, String> names = new HashMap(beans.size());
...
/* 529 */     for (??? = beans.iterator(); ((Iterator)???).hasNext();) { Object bean = ((Iterator)???).next();
/* 530 */       String name = (String)names.get(bean);
...
/* 578 */     return (target instanceof TargetSource) ? (TargetSource)target : new SingletonTargetSource(target);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\framework\ProxyFactoryBean.class
