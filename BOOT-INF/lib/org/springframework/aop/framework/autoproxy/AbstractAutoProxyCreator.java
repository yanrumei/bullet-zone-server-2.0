...
/*     */   
/* 131 */   private final Set<String> targetSourcedBeans = Collections.newSetFromMap(new ConcurrentHashMap(16));
/*     */   
/*     */ 
/* 134 */   private final Set<Object> earlyProxyReferences = Collections.newSetFromMap(new ConcurrentHashMap(16));
/*     */   
/* 136 */   private final Map<Object, Class<?>> proxyTypes = new ConcurrentHashMap(16);
/*     */   
/* 138 */   private final Map<Object, Boolean> advisedBeans = new ConcurrentHashMap(256);
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 223 */     return (Class)this.proxyTypes.get(cacheKey);
/*     */   }
/*     */   
...
/*     */     
/*     */ 
/* 346 */     Object[] specificInterceptors = getAdvicesAndAdvisorsForBean(bean.getClass(), beanName, null);
/* 347 */     if (specificInterceptors != DO_NOT_PROXY) {
/* 348 */       this.advisedBeans.put(cacheKey, Boolean.TRUE);
/* 349 */       Object proxy = createProxy(bean
/* 350 */         .getClass(), beanName, specificInterceptors, new SingletonTargetSource(bean));
...
/*     */   {
/* 407 */     if ((this.customTargetSourceCreators != null) && (this.beanFactory != null) && 
/* 408 */       (this.beanFactory.containsBean(beanName))) {
...
/* 445 */     proxyFactory.copyFrom(this);
/*     */     
...
/* 514 */           allInterceptors.addAll(0, Arrays.asList(commonInterceptors));
/*     */         }
/*     */         else {
/* 517 */           allInterceptors.addAll(Arrays.asList(commonInterceptors));
/*     */         }
/*     */       }
/*     */     }
...
/*     */     
/* 542 */     List<Advisor> advisors = new ArrayList();
...
/*     */       }
/*     */     }
/* 549 */     return (Advisor[])advisors.toArray(new Advisor[advisors.size()]);
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\framework\autoproxy\AbstractAutoProxyCreator.class
