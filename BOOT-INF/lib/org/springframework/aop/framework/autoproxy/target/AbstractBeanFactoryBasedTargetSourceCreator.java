...
/*     */   
/*  65 */   private final Map<String, DefaultListableBeanFactory> internalBeanFactories = new HashMap();
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/*  73 */       throw new IllegalStateException("Cannot do auto-TargetSource creation with a BeanFactory that doesn't implement ConfigurableBeanFactory: " + beanFactory.getClass());
/*     */     }
...
/*     */     }
/* 112 */     internalBeanFactory.registerBeanDefinition(beanName, bdCopy);
/*     */     
/*     */ 
/* 115 */     targetSource.setTargetBeanName(beanName);
/* 116 */     targetSource.setBeanFactory(internalBeanFactory);
/*     */     
/* 118 */     return targetSource;
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 128 */       DefaultListableBeanFactory internalBeanFactory = (DefaultListableBeanFactory)this.internalBeanFactories.get(beanName);
...
/*     */   {
/* 144 */     DefaultListableBeanFactory internalBeanFactory = new DefaultListableBeanFactory(containingFactory);
/*     */     
/*     */ 
...
/* 152 */       if ((it.next() instanceof AopInfrastructureBean)) {
/* 153 */         it.remove();
/*     */       }
/*     */     }
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\framework\autoproxy\target\AbstractBeanFactoryBasedTargetSourceCreator.class
