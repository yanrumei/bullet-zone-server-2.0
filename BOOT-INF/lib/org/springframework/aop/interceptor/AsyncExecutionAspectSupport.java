...
/*     */   
/*  80 */   private final Map<Method, AsyncTaskExecutor> executors = new ConcurrentHashMap(16);
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 154 */     AsyncTaskExecutor executor = (AsyncTaskExecutor)this.executors.get(method);
/* 155 */     if (executor == null)
/*     */     {
/* 157 */       String qualifier = getExecutorQualifier(method);
/* 158 */       Executor targetExecutor; Executor targetExecutor; if (StringUtils.hasLength(qualifier)) {
...
/* 173 */         return null;
/*     */       }
/* 175 */       executor = (targetExecutor instanceof AsyncListenableTaskExecutor) ? (AsyncListenableTaskExecutor)targetExecutor : new TaskExecutorAdapter(targetExecutor);
/*     */       
...
/* 231 */         this.logger.debug("Could not find unique TaskExecutor bean", ex);
/*     */         try {
...
/* 244 */         this.logger.debug("Could not find default TaskExecutor bean", ex);
/*     */         try {
...
/*     */   {
/*     */     public static <T> Future<T> processCompletableFuture(Class<?> returnType, Callable<T> task, Executor executor)
/*     */     {
/* 321 */       if (!CompletableFuture.class.isAssignableFrom(returnType)) {
/* 322 */         return null;
/*     */       }
/* 324 */       CompletableFuture.supplyAsync(new Supplier()
/*     */       {
/*     */         public T get() {
/*     */           try {
/* 328 */             return (T)this.val$task.call();
/*     */           }
/*     */           catch (Throwable ex) {
/* 331 */             throw new CompletionException(ex); } } }, executor);
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-aop-4.3.14.RELEASE.jar!\org\springframework\aop\interceptor\AsyncExecutionAspectSupport.class
