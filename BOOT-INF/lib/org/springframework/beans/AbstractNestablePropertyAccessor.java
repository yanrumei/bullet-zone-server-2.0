...
/*  329 */       List<Object> list = (List)propValue;
...
/*  367 */       Map<Object, Object> map = (Map)propValue;
/*      */       
/*      */ 
...
/*  480 */       if ((cause instanceof UndeclaredThrowableException))
/*      */       {
...
/*  662 */             List<Object> list = (List)value;
...
/*      */           {
/*  668 */             Set<Object> set = (Set)value;
/*  669 */             int index = Integer.parseInt(key);
/*  670 */             if ((index < 0) || (index >= set.size()))
/*      */             {
/*      */ 
/*  673 */               throw new InvalidPropertyException(getRootClass(), this.nestedPath + propertyName, "Cannot get element with index " + index + " from Set of size " + set.size() + ", accessed using property path '" + propertyName + "'");
/*      */             }
...
/*  685 */             Map<Object, Object> map = (Map)value;
...
/*  690 */             Object convertedMapKey = convertIfNecessary(null, null, key, mapKeyType, typeDescriptor);
...
/*  773 */         Array.set(newArray, i, newValue(componentType, null, name));
/*      */       }
...
/*  794 */           collection.add(newValue(elementType, null, name));
/*      */         }
/*      */       }
/*      */     }
/*      */   }
...
/*  843 */       this.nestedPropertyAccessors = new HashMap();
/*      */     }
/*      */     
...
/*      */     
/*      */ 
/*  859 */     AbstractNestablePropertyAccessor nestedPa = (AbstractNestablePropertyAccessor)this.nestedPropertyAccessors.get(canonicalName);
/*  860 */     if (nestedPa != null) {
/*  861 */       if (nestedPa.getWrappedInstance() == (value.getClass() == javaUtilOptionalClass ? OptionalUnwrapper.unwrap(value) : value)) {}
...
/*      */     catch (Throwable ex)
/*      */     {
/*  931 */       throw new NullValueInNestedPathException(getRootClass(), this.nestedPath + name, "Could not instantiate property type [" + type.getName() + "] to auto-grow nested property path", ex);
/*      */     }
/*      */   }
/*      */   
/*      */ 
...
/*  943 */     List<String> keys = new ArrayList(2);
...
/*  955 */           if (((key.length() > 1) && (key.startsWith("'")) && (key.endsWith("'"))) || (
/*  956 */             (key.startsWith("\"")) && (key.endsWith("\"")))) {
...
/*  966 */     if (!keys.isEmpty()) {
/*  967 */       PropertyTokenHolder tmp224_223 = tokens;
/*  968 */       tmp224_223.canonicalName = (tmp224_223.canonicalName + "[" + StringUtils.collectionToDelimitedString(keys, "][") + "]");
/*      */       
...
/*      */   
/*      */   protected static abstract class PropertyHandler { private final Class<?> propertyType;
/*      */     private final boolean readable;
/*      */     private final boolean writable;
/*      */     
/*  997 */     public PropertyHandler(Class<?> propertyType, boolean readable, boolean writable) { this.propertyType = propertyType;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\AbstractNestablePropertyAccessor.class
