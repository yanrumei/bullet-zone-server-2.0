...
/*     */   
/*  75 */   static { try { closeableInterface = ClassUtils.forName("java.lang.AutoCloseable", DisposableBeanAdapter.class
/*  76 */         .getClassLoader());
/*     */     }
...
/*     */     
/* 116 */     this.invokeDisposableBean = (((this.bean instanceof DisposableBean)) && (!beanDefinition.isExternallyManagedDestroyMethod("destroy")));
...
/* 194 */       (closeableInterface.isInstance(bean))))
/*     */     {
/*     */ 
...
/* 301 */         (Method)AccessController.doPrivileged(new PrivilegedAction()
/*     */         {
/*     */           public Method run() {
...
/*     */     {
/* 314 */       throw new BeanDefinitionValidationException("Could not find unique destroy method on bean with name '" + this.beanName + ": " + ex.getMessage());
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\support\DisposableBeanAdapter.class
