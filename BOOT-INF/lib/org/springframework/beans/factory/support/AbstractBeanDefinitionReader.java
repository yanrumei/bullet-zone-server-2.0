...
/*     */     }
/*     */     else {
/*  89 */       this.resourceLoader = new PathMatchingResourcePatternResolver();
/*     */     }
/*     */     
/*     */ 
...
/*     */     }
/*     */     else {
/*  97 */       this.environment = new StandardEnvironment();
/*     */     }
/*     */   }
/*     */   
...
/* 217 */         int loadCount = loadBeanDefinitions(resources);
/* 218 */         if (actualResources != null) {
/* 219 */           for (Resource resource : resources) {
/* 220 */             actualResources.add(resource);
/*     */           }
/*     */         }
/* 223 */         if (this.logger.isDebugEnabled()) {
/* 224 */           this.logger.debug("Loaded " + loadCount + " bean definitions from location pattern [" + location + "]");
/*     */         }
/* 226 */         return loadCount;
/*     */       }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\support\AbstractBeanDefinitionReader.class
