...
/*    */   {
/* 50 */     return (this.beanFactory.containsBean(key)) || ((this.scope != null) && 
/* 51 */       (this.scope.resolveContextualObject(key) != null));
/*    */   }
/*    */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\config\BeanExpressionContext.class
