...
/*     */     {
/* 228 */       throw new IllegalArgumentException("serviceLocatorException [" + serviceLocatorExceptionClass.getName() + "] is not a subclass of Exception");
/*     */     }
/*     */     
/* 231 */     this.serviceLocatorExceptionConstructor = determineServiceLocatorExceptionConstructor(serviceLocatorExceptionClass);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 265 */       .getClassLoader(), new Class[] { this.serviceLocatorInterface }, new ServiceLocatorInvocationHandler(null));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     try
/*     */     {
/* 284 */       return exceptionClass.getConstructor(new Class[] { String.class, Throwable.class });
/*     */     }
/*     */     catch (NoSuchMethodException ex) {
/*     */       try {
/* 288 */         return exceptionClass.getConstructor(new Class[] { Throwable.class });
/*     */       }
/*     */       catch (NoSuchMethodException ex2) {
/*     */         try {
/* 292 */           return exceptionClass.getConstructor(new Class[] { String.class });
/*     */         }
/*     */         catch (NoSuchMethodException ex3)
/*     */         {
/* 296 */           throw new IllegalArgumentException("Service locator exception [" + exceptionClass.getName() + "] neither has a (String, Throwable) constructor nor a (String) constructor");
/*     */         }
/*     */       }
/*     */     }
/*     */   }
...
/*     */       
/*     */ 
/* 412 */       if ((paramTypes.length > 1) || (Void.TYPE == serviceLocatorReturnType)) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\config\ServiceLocatorFactoryBean.class
