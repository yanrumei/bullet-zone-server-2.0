...
/*     */   
/*     */ 
/* 278 */   private static final Map<String, BeanFactoryLocator> instances = new HashMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */       }
/* 325 */       BeanFactoryLocator bfl = (BeanFactoryLocator)instances.get(resourceLocation);
/* 326 */       if (bfl == null) {
...
/*     */ 
/*     */ 
/* 336 */   private final Map<String, BeanFactoryGroup> bfgInstancesByKey = new HashMap();
/*     */   
/* 338 */   private final Map<BeanFactory, BeanFactoryGroup> bfgInstancesByObj = new HashMap();
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 356 */       BeanFactoryGroup bfg = (BeanFactoryGroup)this.bfgInstancesByKey.get(this.resourceLocation);
/*     */       
/* 358 */       if (bfg != null) {
/* 359 */         BeanFactoryGroup.access$008(bfg);
/*     */       }
/*     */       else
/*     */       {
...
/*     */         
/*     */ 
/* 372 */         bfg = new BeanFactoryGroup(null);
...
/* 518 */           if (bfg != null) {
/* 519 */             SingletonBeanFactoryLocator.BeanFactoryGroup.access$010(bfg);
/* 520 */             if (SingletonBeanFactoryLocator.BeanFactoryGroup.access$000(bfg) == 0) {
...
/*     */           else
/*     */           {
/* 528 */             SingletonBeanFactoryLocator.logger.warn("Tried to release a SingletonBeanFactoryLocator group definition more times than it has actually been used. Resource name [" + 
/* 529 */               SingletonBeanFactoryLocator.this.resourceLocation + "]");
/*     */           }
/*     */         }
/*     */       }
/*     */     }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\access\SingletonBeanFactoryLocator.class
