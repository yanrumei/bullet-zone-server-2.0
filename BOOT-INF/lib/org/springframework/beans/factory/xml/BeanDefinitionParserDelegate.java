...
/*      */     
/*  440 */     List<String> aliases = new ArrayList();
...
/*  448 */       beanName = (String)aliases.remove(0);
...
/*  464 */             beanName = BeanDefinitionReaderUtils.generateBeanName(beanDefinition, this.readerContext
...
/*  785 */         overrides.addOverride(override);
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*  812 */         overrides.addOverride(replaceOverride);
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/*      */           try
/*      */           {
/*  832 */             this.parseState.push(new ConstructorArgumentEntry(index));
...
/*      */       try
/*      */       {
/*  860 */         this.parseState.push(new ConstructorArgumentEntry());
...
/*  885 */       return;
/*      */     }
/*  887 */     this.parseState.push(new PropertyEntry(propertyName));
/*      */     try {
...
/*  911 */       return;
/*      */     }
/*  913 */     this.parseState.push(new QualifierEntry(typeName));
/*      */     try {
...
/*  919 */         qualifier.setAttribute(AutowireCandidateQualifier.VALUE_KEY, value);
/*      */       }
...
/* 1140 */     TypedStringValue typedValue; if (!StringUtils.hasText(targetTypeName)) {
/* 1141 */       typedValue = new TypedStringValue(value);
/*      */     } else { TypedStringValue typedValue;
/* 1143 */       if (classLoader != null) {
...
/* 1163 */     parseCollectionElements(nl, target, bd, elementType);
/* 1164 */     return target;
/*      */   }
/*      */   
/*      */ 
...
/* 1177 */     parseCollectionElements(nl, target, bd, defaultElementType);
/* 1178 */     return target;
/*      */   }
/*      */   
/*      */ 
...
/* 1431 */     for (int i = 0; i < children.getLength(); i++) {
/* 1432 */       Node node = children.item(i);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\xml\BeanDefinitionParserDelegate.class
