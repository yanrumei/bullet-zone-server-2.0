...
/*     */ {
/*  61 */   private final Set<Class<? extends Annotation>> qualifierTypes = new LinkedHashSet(2);
/*     */   
/*  63 */   private Class<? extends Annotation> valueAnnotationType = Value.class;
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 153 */           if ((method == null) || (Void.TYPE == method.getReturnType())) {
...
/* 270 */       String attributeName = (String)entry.getKey();
...
/*     */       }
/* 281 */       if ((actualValue != null) || (!attributeName.equals(AutowireCandidateQualifier.VALUE_KEY)) || (!(expectedValue instanceof String)) || 
/* 282 */         (!bdHolder.matchesName((String)expectedValue)))
/*     */       {
/*     */ 
/*     */ 
...
/*     */   {
/* 345 */     AnnotationAttributes attr = AnnotatedElementUtils.getMergedAnnotationAttributes(
/* 346 */       AnnotatedElementUtils.forAnnotations(annotationsToSearch), this.valueAnnotationType);
/* 347 */     if (attr != null) {
/* 348 */       return extractValue(attr);
/*     */     }
/* 350 */     return null;
/*     */   }
/*     */   
...
/*     */   {
/* 358 */     Object value = attr.get("value");
/* 359 */     if (value == null) {
/* 360 */       throw new IllegalStateException("Value annotation must have a value attribute");
/*     */     }
/* 362 */     return value;
/*     */   }
/*     */ }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\spring-beans-4.3.14.RELEASE.jar!\org\springframework\beans\factory\annotation\QualifierAnnotationAutowireCandidateResolver.class
