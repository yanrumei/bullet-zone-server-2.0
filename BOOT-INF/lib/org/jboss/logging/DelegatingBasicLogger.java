...
/*      */   {
/*   59 */     this.log.trace(FQCN, message, null);
/*      */   }
/*      */   
...
/*      */   {
/*   79 */     this.log.logv(FQCN, Logger.Level.TRACE, null, format, params);
/*      */   }
/*      */   
/*      */   public void tracev(String format, Object param1)
/*      */   {
/*   84 */     this.log.logv(FQCN, Logger.Level.TRACE, null, format, param1);
/*      */   }
/*      */   
/*      */   public void tracev(String format, Object param1, Object param2)
/*      */   {
/*   89 */     this.log.logv(FQCN, Logger.Level.TRACE, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void tracev(String format, Object param1, Object param2, Object param3)
/*      */   {
/*   94 */     this.log.logv(FQCN, Logger.Level.TRACE, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  119 */     this.log.logf(FQCN, Logger.Level.TRACE, null, format, params);
/*      */   }
/*      */   
/*      */   public void tracef(String format, Object param1)
/*      */   {
/*  124 */     this.log.logf(FQCN, Logger.Level.TRACE, null, format, param1);
/*      */   }
/*      */   
/*      */   public void tracef(String format, Object param1, Object param2)
/*      */   {
/*  129 */     this.log.logf(FQCN, Logger.Level.TRACE, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void tracef(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  134 */     this.log.logf(FQCN, Logger.Level.TRACE, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  284 */     this.log.debug(FQCN, message, null);
/*      */   }
/*      */   
...
/*      */   {
/*  304 */     this.log.logv(FQCN, Logger.Level.DEBUG, null, format, params);
/*      */   }
/*      */   
/*      */   public void debugv(String format, Object param1)
/*      */   {
/*  309 */     this.log.logv(FQCN, Logger.Level.DEBUG, null, format, param1);
/*      */   }
/*      */   
/*      */   public void debugv(String format, Object param1, Object param2)
/*      */   {
/*  314 */     this.log.logv(FQCN, Logger.Level.DEBUG, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void debugv(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  319 */     this.log.logv(FQCN, Logger.Level.DEBUG, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  344 */     this.log.logf(FQCN, Logger.Level.DEBUG, null, format, params);
/*      */   }
/*      */   
/*      */   public void debugf(String format, Object param1)
/*      */   {
/*  349 */     this.log.logf(FQCN, Logger.Level.DEBUG, null, format, param1);
/*      */   }
/*      */   
/*      */   public void debugf(String format, Object param1, Object param2)
/*      */   {
/*  354 */     this.log.logf(FQCN, Logger.Level.DEBUG, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void debugf(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  359 */     this.log.logf(FQCN, Logger.Level.DEBUG, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  509 */     this.log.info(FQCN, message, null);
/*      */   }
/*      */   
...
/*      */   {
/*  529 */     this.log.logv(FQCN, Logger.Level.INFO, null, format, params);
/*      */   }
/*      */   
/*      */   public void infov(String format, Object param1)
/*      */   {
/*  534 */     this.log.logv(FQCN, Logger.Level.INFO, null, format, param1);
/*      */   }
/*      */   
/*      */   public void infov(String format, Object param1, Object param2)
/*      */   {
/*  539 */     this.log.logv(FQCN, Logger.Level.INFO, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void infov(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  544 */     this.log.logv(FQCN, Logger.Level.INFO, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  569 */     this.log.logf(FQCN, Logger.Level.INFO, null, format, params);
/*      */   }
/*      */   
/*      */   public void infof(String format, Object param1)
/*      */   {
/*  574 */     this.log.logf(FQCN, Logger.Level.INFO, null, format, param1);
/*      */   }
/*      */   
/*      */   public void infof(String format, Object param1, Object param2)
/*      */   {
/*  579 */     this.log.logf(FQCN, Logger.Level.INFO, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void infof(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  584 */     this.log.logf(FQCN, Logger.Level.INFO, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  609 */     this.log.warn(FQCN, message, null);
/*      */   }
/*      */   
...
/*      */   {
/*  629 */     this.log.logv(FQCN, Logger.Level.WARN, null, format, params);
/*      */   }
/*      */   
/*      */   public void warnv(String format, Object param1)
/*      */   {
/*  634 */     this.log.logv(FQCN, Logger.Level.WARN, null, format, param1);
/*      */   }
/*      */   
/*      */   public void warnv(String format, Object param1, Object param2)
/*      */   {
/*  639 */     this.log.logv(FQCN, Logger.Level.WARN, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void warnv(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  644 */     this.log.logv(FQCN, Logger.Level.WARN, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  669 */     this.log.logf(FQCN, Logger.Level.WARN, null, format, params);
/*      */   }
/*      */   
/*      */   public void warnf(String format, Object param1)
/*      */   {
/*  674 */     this.log.logf(FQCN, Logger.Level.WARN, null, format, param1);
/*      */   }
/*      */   
/*      */   public void warnf(String format, Object param1, Object param2)
/*      */   {
/*  679 */     this.log.logf(FQCN, Logger.Level.WARN, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void warnf(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  684 */     this.log.logf(FQCN, Logger.Level.WARN, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  709 */     this.log.error(FQCN, message, null);
/*      */   }
/*      */   
...
/*      */   {
/*  729 */     this.log.logv(FQCN, Logger.Level.ERROR, null, format, params);
/*      */   }
/*      */   
/*      */   public void errorv(String format, Object param1)
/*      */   {
/*  734 */     this.log.logv(FQCN, Logger.Level.ERROR, null, format, param1);
/*      */   }
/*      */   
/*      */   public void errorv(String format, Object param1, Object param2)
/*      */   {
/*  739 */     this.log.logv(FQCN, Logger.Level.ERROR, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void errorv(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  744 */     this.log.logv(FQCN, Logger.Level.ERROR, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  769 */     this.log.logf(FQCN, Logger.Level.ERROR, null, format, params);
/*      */   }
/*      */   
/*      */   public void errorf(String format, Object param1)
/*      */   {
/*  774 */     this.log.logf(FQCN, Logger.Level.ERROR, null, format, param1);
/*      */   }
/*      */   
/*      */   public void errorf(String format, Object param1, Object param2)
/*      */   {
/*  779 */     this.log.logf(FQCN, Logger.Level.ERROR, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void errorf(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  784 */     this.log.logf(FQCN, Logger.Level.ERROR, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  809 */     this.log.fatal(FQCN, message, null);
/*      */   }
/*      */   
...
/*      */   {
/*  829 */     this.log.logv(FQCN, Logger.Level.FATAL, null, format, params);
/*      */   }
/*      */   
/*      */   public void fatalv(String format, Object param1)
/*      */   {
/*  834 */     this.log.logv(FQCN, Logger.Level.FATAL, null, format, param1);
/*      */   }
/*      */   
/*      */   public void fatalv(String format, Object param1, Object param2)
/*      */   {
/*  839 */     this.log.logv(FQCN, Logger.Level.FATAL, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void fatalv(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  844 */     this.log.logv(FQCN, Logger.Level.FATAL, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  869 */     this.log.logf(FQCN, Logger.Level.FATAL, null, format, params);
/*      */   }
/*      */   
/*      */   public void fatalf(String format, Object param1)
/*      */   {
/*  874 */     this.log.logf(FQCN, Logger.Level.FATAL, null, format, param1);
/*      */   }
/*      */   
/*      */   public void fatalf(String format, Object param1, Object param2)
/*      */   {
/*  879 */     this.log.logf(FQCN, Logger.Level.FATAL, null, format, param1, param2);
/*      */   }
/*      */   
/*      */   public void fatalf(String format, Object param1, Object param2, Object param3)
/*      */   {
/*  884 */     this.log.logf(FQCN, Logger.Level.FATAL, null, format, param1, param2, param3);
/*      */   }
/*      */   
...
/*      */   {
/*  910 */     this.log.log(FQCN, level, message, null, null);
/*      */   }
/*      */   
/*      */   public void log(Logger.Level level, Object message, Throwable t)
/*      */   {
/*  915 */     this.log.log(FQCN, level, message, null, t);
/*      */   }
/*      */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jboss-logging-3.3.1.Final.jar!\org\jboss\logging\DelegatingBasicLogger.class
