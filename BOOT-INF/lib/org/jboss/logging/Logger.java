...
/*  374 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Integer.valueOf(arg) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, int arg1, int arg2) {
/*  379 */     if (isEnabled(Level.TRACE)) {
/*  380 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Integer.valueOf(arg1), Integer.valueOf(arg2) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, int arg1, Object arg2) {
/*  385 */     if (isEnabled(Level.TRACE)) {
/*  386 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Integer.valueOf(arg1), arg2 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, int arg1, int arg2, int arg3) {
/*  391 */     if (isEnabled(Level.TRACE)) {
/*  392 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Integer.valueOf(arg1), Integer.valueOf(arg2), Integer.valueOf(arg3) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, int arg1, int arg2, Object arg3) {
/*  397 */     if (isEnabled(Level.TRACE)) {
/*  398 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Integer.valueOf(arg1), Integer.valueOf(arg2), arg3 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, int arg1, Object arg2, Object arg3) {
/*  403 */     if (isEnabled(Level.TRACE)) {
/*  404 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Integer.valueOf(arg1), arg2, arg3 }, null);
/*      */     }
/*      */   }
/*      */   
...
/*  446 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Long.valueOf(arg) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, long arg1, long arg2) {
/*  451 */     if (isEnabled(Level.TRACE)) {
/*  452 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Long.valueOf(arg1), Long.valueOf(arg2) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, long arg1, Object arg2) {
/*  457 */     if (isEnabled(Level.TRACE)) {
/*  458 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Long.valueOf(arg1), arg2 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, long arg1, long arg2, long arg3) {
/*  463 */     if (isEnabled(Level.TRACE)) {
/*  464 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Long.valueOf(arg1), Long.valueOf(arg2), Long.valueOf(arg3) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, long arg1, long arg2, Object arg3) {
/*  469 */     if (isEnabled(Level.TRACE)) {
/*  470 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Long.valueOf(arg1), Long.valueOf(arg2), arg3 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void tracef(String format, long arg1, Object arg2, Object arg3) {
/*  475 */     if (isEnabled(Level.TRACE)) {
/*  476 */       doLogf(Level.TRACE, FQCN, format, new Object[] { Long.valueOf(arg1), arg2, arg3 }, null);
/*      */     }
/*      */   }
/*      */   
...
/*  798 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Integer.valueOf(arg) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, int arg1, int arg2) {
/*  803 */     if (isEnabled(Level.DEBUG)) {
/*  804 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Integer.valueOf(arg1), Integer.valueOf(arg2) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, int arg1, Object arg2) {
/*  809 */     if (isEnabled(Level.DEBUG)) {
/*  810 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Integer.valueOf(arg1), arg2 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, int arg1, int arg2, int arg3) {
/*  815 */     if (isEnabled(Level.DEBUG)) {
/*  816 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Integer.valueOf(arg1), Integer.valueOf(arg2), Integer.valueOf(arg3) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, int arg1, int arg2, Object arg3) {
/*  821 */     if (isEnabled(Level.DEBUG)) {
/*  822 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Integer.valueOf(arg1), Integer.valueOf(arg2), arg3 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, int arg1, Object arg2, Object arg3) {
/*  827 */     if (isEnabled(Level.DEBUG)) {
/*  828 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Integer.valueOf(arg1), arg2, arg3 }, null);
/*      */     }
/*      */   }
/*      */   
...
/*  870 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Long.valueOf(arg) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, long arg1, long arg2) {
/*  875 */     if (isEnabled(Level.DEBUG)) {
/*  876 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Long.valueOf(arg1), Long.valueOf(arg2) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, long arg1, Object arg2) {
/*  881 */     if (isEnabled(Level.DEBUG)) {
/*  882 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Long.valueOf(arg1), arg2 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, long arg1, long arg2, long arg3) {
/*  887 */     if (isEnabled(Level.DEBUG)) {
/*  888 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Long.valueOf(arg1), Long.valueOf(arg2), Long.valueOf(arg3) }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, long arg1, long arg2, Object arg3) {
/*  893 */     if (isEnabled(Level.DEBUG)) {
/*  894 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Long.valueOf(arg1), Long.valueOf(arg2), arg3 }, null);
/*      */     }
/*      */   }
/*      */   
/*      */   public void debugf(String format, long arg1, Object arg2, Object arg3) {
/*  899 */     if (isEnabled(Level.DEBUG)) {
/*  900 */       doLogf(Level.DEBUG, FQCN, format, new Object[] { Long.valueOf(arg1), arg2, arg3 }, null);
/*      */     }
/*      */   }
/*      */   
...
/*      */   {
/* 2479 */     return getLogger(name + "." + suffix);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/* 2516 */     return (T)getMessageLogger(type, category, LoggingLocale.getLocale());
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*      */   public static <T> T getMessageLogger(final Class<T> type, final String category, Locale locale)
/*      */   {
/* 2529 */     (T)AccessController.doPrivileged(new PrivilegedAction() {
/*      */       public T run() {
/* 2531 */         String language = this.val$locale.getLanguage();
/* 2532 */         String country = this.val$locale.getCountry();
/* 2533 */         String variant = this.val$locale.getVariant();
/*      */         
/* 2535 */         Class<? extends T> loggerClass = null;
/* 2536 */         ClassLoader classLoader = type.getClassLoader();
/* 2537 */         String typeName = type.getName();
/* 2538 */         if ((variant != null) && (variant.length() > 0)) {
/* 2539 */           try { loggerClass = Class.forName(Logger.join(typeName, "$logger", language, country, variant), true, classLoader).asSubclass(type);
/*      */           }
/*      */           catch (ClassNotFoundException localClassNotFoundException1) {}
/*      */         }
/* 2543 */         if ((loggerClass == null) && (country != null) && (country.length() > 0)) {
/* 2544 */           try { loggerClass = Class.forName(Logger.join(typeName, "$logger", language, country, null), true, classLoader).asSubclass(type);
/*      */           }
/*      */           catch (ClassNotFoundException localClassNotFoundException2) {}
/*      */         }
/* 2548 */         if ((loggerClass == null) && (language != null) && (language.length() > 0)) {
/* 2549 */           try { loggerClass = Class.forName(Logger.join(typeName, "$logger", language, null, null), true, classLoader).asSubclass(type);
/*      */           }
/*      */           catch (ClassNotFoundException localClassNotFoundException3) {}
/*      */         }
/* 2553 */         if (loggerClass == null) {
/* 2554 */           try { loggerClass = Class.forName(Logger.join(typeName, "$logger", null, null, null), true, classLoader).asSubclass(type);
/*      */           } catch (ClassNotFoundException e) {
/* 2556 */             throw new IllegalArgumentException("Invalid logger " + type + " (implementation not found in " + classLoader + ")");
/*      */           }
/*      */         }
/*      */         try {
/* 2560 */           constructor = loggerClass.getConstructor(new Class[] { Logger.class });
/*      */         } catch (NoSuchMethodException e) { Constructor<? extends T> constructor;
/* 2562 */           throw new IllegalArgumentException("Logger implementation " + loggerClass + " has no matching constructor");
/*      */         }
/*      */         try { Constructor<? extends T> constructor;
/* 2565 */           return (T)constructor.newInstance(new Object[] { Logger.getLogger(category) });
/*      */         } catch (InstantiationException e) {
/* 2567 */           throw new IllegalArgumentException("Logger implementation " + loggerClass + " could not be instantiated", e);
/*      */         } catch (IllegalAccessException e) {
/* 2569 */           throw new IllegalArgumentException("Logger implementation " + loggerClass + " could not be instantiated", e);
/*      */         } catch (InvocationTargetException e) {
/* 2571 */           throw new IllegalArgumentException("Logger implementation " + loggerClass + " could not be instantiated", e.getCause());
/*      */         }
/*      */       }
/*      */     });
/*      */   }
...
/* 2578 */     StringBuilder build = new StringBuilder();
/* 2579 */     build.append(interfaceName).append('_').append(a);
/* 2580 */     if ((b != null) && (b.length() > 0)) {
/* 2581 */       build.append('_');
/* 2582 */       build.append(b);
/*      */     }
/* 2584 */     if ((c != null) && (c.length() > 0)) {
/* 2585 */       build.append('_');
/* 2586 */       build.append(c);
/*      */     }
/* 2588 */     if ((d != null) && (d.length() > 0)) {
/* 2589 */       build.append('_');
/* 2590 */       build.append(d);
/*      */     }
/* 2592 */     return build.toString();
/*      */   }
/*      */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jboss-logging-3.3.1.Final.jar!\org\jboss\logging\Logger.class
