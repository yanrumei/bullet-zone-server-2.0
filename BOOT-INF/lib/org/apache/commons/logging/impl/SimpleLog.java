...
/* 676 */     (InputStream)AccessController.doPrivileged(new PrivilegedAction() {
/*     */       public InputStream run() {
/* 678 */         ClassLoader threadCL = SimpleLog.access$000();
/*     */         
/* 680 */         if (threadCL != null) {
/* 681 */           return threadCL.getResourceAsStream(this.val$name);
/*     */         }
/* 683 */         return ClassLoader.getSystemResourceAsStream(this.val$name);
/*     */       }
/*     */     });
/*     */   }
/*     */ }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jcl-over-slf4j-1.7.25.jar!\org\apache\commons\logging\impl\SimpleLog.class
