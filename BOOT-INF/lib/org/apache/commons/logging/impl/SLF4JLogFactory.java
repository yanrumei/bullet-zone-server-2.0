...
/*     */   {
/*  67 */     this.loggerMap = new ConcurrentHashMap();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws LogConfigurationException
/*     */   {
/* 150 */     Log instance = (Log)this.loggerMap.get(name);
/* 151 */     if (instance != null) {
/* 152 */       return instance;
/*     */     }
/*     */     
/* 155 */     Logger slf4jLogger = LoggerFactory.getLogger(name);
/* 156 */     Log newInstance; Log newInstance; if ((slf4jLogger instanceof LocationAwareLogger)) {
/* 157 */       newInstance = new SLF4JLocationAwareLog((LocationAwareLogger)slf4jLogger);
/*     */     } else {
/* 159 */       newInstance = new SLF4JLog(slf4jLogger);
/*     */     }
/* 161 */     Log oldInstance = (Log)this.loggerMap.putIfAbsent(name, newInstance);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jcl-over-slf4j-1.7.25.jar!\org\apache\commons\logging\impl\SLF4JLogFactory.class
