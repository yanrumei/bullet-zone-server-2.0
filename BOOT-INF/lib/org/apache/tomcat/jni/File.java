...
public class File
{
  ...
  public static native FileInfo getStat(String paramString, int paramInt, long paramLong);
  
  public static native int infoGet(FileInfo paramFileInfo, int paramInt, long paramLong);
  
  public static native FileInfo getInfo(int paramInt, long paramLong);
}


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\tomcat-embed-core-8.5.27.jar!\org\apache\tomcat\jni\File.class
