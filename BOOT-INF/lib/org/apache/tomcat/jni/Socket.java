...
public class Socket
{
  ...
  public static native long acceptx(long paramLong1, long paramLong2)
    throws Exception;
  ...
  public static native int sendib(long paramLong, ByteBuffer paramByteBuffer, int paramInt1, int paramInt2);
  
  public static native int sendbb(long paramLong, int paramInt1, int paramInt2);
  
  public static native int sendibb(long paramLong, int paramInt1, int paramInt2);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\tomcat-embed-core-8.5.27.jar!\org\apache\tomcat\jni\Socket.class
