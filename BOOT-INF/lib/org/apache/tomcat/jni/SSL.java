...
public final class SSL
{
  ...
  public static native int fipsModeSet(int paramInt)
    throws Exception;
  ...
  public static native boolean hasOp(int paramInt);
  ...
  public static native void setBIO(long paramLong1, long paramLong2, long paramLong3);
  
  public static native int getError(long paramLong, int paramInt);
  
  public static native int pendingWrittenBytesInBIO(long paramLong);
  
  public static native int pendingReadableBytesInSSL(long paramLong);
  
  public static native int writeToBIO(long paramLong1, long paramLong2, int paramInt);
  
  public static native int readFromBIO(long paramLong1, long paramLong2, int paramInt);
  ...
  public static native long makeNetworkBIO(long paramLong);
  ...
  public static native boolean setCipherSuites(long paramLong, String paramString)
    throws Exception;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\tomcat-embed-core-8.5.27.jar!\org\apache\tomcat\jni\SSL.class
