...
/*     */ 
/*     */ 
/* 102 */   private static final String[] API_COMPATIBILITY_LIST = { "1.6", "1.7" };
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 204 */     List<SubstituteLoggingEvent> eventList = new ArrayList(128);
/*     */     for (;;) {
...
/*     */       }
/* 271 */       if (!match) {
/* 272 */         Util.report("The requested version " + requested + " by your slf4j binding is not compatible with " + Arrays.asList(API_COMPATIBILITY_LIST).toString());
/*     */         
...
/*     */   {
/* 296 */     Set<URL> staticLoggerBinderPathSet = new LinkedHashSet();
/*     */     try {
/* 298 */       ClassLoader loggerFactoryClassLoader = LoggerFactory.class.getClassLoader();
/*     */       Enumeration<URL> paths;
/* 300 */       Enumeration<URL> paths; if (loggerFactoryClassLoader == null) {
...
/* 306 */         URL path = (URL)paths.nextElement();
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\slf4j-api-1.7.25.jar!\org\slf4j\LoggerFactory.class
