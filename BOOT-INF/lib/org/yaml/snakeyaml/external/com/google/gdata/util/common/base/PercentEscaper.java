...
/* 152 */     for (int c = 48; c <= 57; c++) {
/* 153 */       octets[c] = true;
/*     */     }
/* 155 */     for (int c = 65; c <= 90; c++) {
/* 156 */       octets[c] = true;
/*     */     }
/* 158 */     for (int c = 97; c <= 122; c++) {
/* 159 */       octets[c] = true;
/*     */     }
...
/* 193 */       if ((c >= this.safeOctets.length) || (this.safeOctets[c] == 0)) {
...
/*     */   {
/* 208 */     if ((cp < this.safeOctets.length) && (this.safeOctets[cp] != 0))
/* 209 */       return null;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\snakeyaml-1.17.jar!\org\yaml\snakeyaml\external\com\google\gdat\\util\common\base\PercentEscaper.class
