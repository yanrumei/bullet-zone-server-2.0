...
/*     */     int unread;
/*  92 */     Charset encoding; int unread; if ((bom[0] == -17) && (bom[1] == -69) && (bom[2] == -65)) {
/*  93 */       Charset encoding = UTF8;
/*  94 */       unread = n - 3; } else { int unread;
/*  95 */       if ((bom[0] == -2) && (bom[1] == -1)) {
/*  96 */         Charset encoding = UTF16BE;
/*  97 */         unread = n - 2; } else { int unread;
/*  98 */         if ((bom[0] == -1) && (bom[1] == -2)) {
/*  99 */           Charset encoding = UTF16LE;
/* 100 */           unread = n - 2;
/*     */         }
/*     */         else {
/* 103 */           encoding = UTF8;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\snakeyaml-1.17.jar!\org\yaml\snakeyaml\reader\UnicodeReader.class
