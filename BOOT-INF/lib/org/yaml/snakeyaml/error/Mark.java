...
/*  79 */     result.append("\n");
/*  80 */     for (int i = 0; i < indent + this.pointer - start + head.length(); i++) {
/*  81 */       result.append(" ");
/*     */     }
/*  83 */     result.append("^");
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\snakeyaml-1.17.jar!\org\yaml\snakeyaml\error\Mark.class
