...
/*  51 */       Map<String, Object> properties = new HashMap(data.getProperties());
...
/* 139 */       if (list.size() == 1) {
/* 140 */         NodeTuple tuple = (NodeTuple)list.get(0);
...
/*     */   }
/*     */   
/* 158 */   public class ConstructCompactObject extends Constructor.ConstructMapping { public ConstructCompactObject() { super(); }
/*     */     
/*     */ 
/*     */     public void construct2ndStep(Node node, Object object)
/*     */     {
/* 163 */       MappingNode mnode = (MappingNode)node;
/* 164 */       NodeTuple nodeTuple = (NodeTuple)mnode.getValue().iterator().next();
/*     */       
...
/* 186 */         NodeTuple nodeTuple = (NodeTuple)mnode.getValue().iterator().next();
...
/* 221 */       Property property = (Property)iterator.next();
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\snakeyaml-1.17.jar!\org\yaml\snakeyaml\extensions\compactnotation\CompactConstructor.class
