...
/* 42 */   boolean[] contains = new boolean[''];
...
/* 62 */     return (this.noASCII) && (this.content.indexOf(ch, 0) != -1) ? true : ch < '' ? this.contains[ch] : false;
/*    */   }
/*    */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\snakeyaml-1.17.jar!\org\yaml\snakeyaml\scanner\Constant.class
