...
/*     */   
/* 199 */   public static final String LEFT_ACCOLADE = new String(new char[] { '{' });
/* 200 */   public static final String RIGHT_ACCOLADE = new String(new char[] { '}' });
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\CoreConstants.class
