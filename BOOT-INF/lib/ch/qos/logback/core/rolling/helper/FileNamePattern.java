...
/*  65 */       Parser<Object> p = new Parser(patternForParsing, new AlmostAsIsEscapeUtil());
/*  66 */       p.setContext(this.context);
/*  67 */       Node t = p.parse();
/*  68 */       this.headTokenConverter = p.compile(t, CONVERTER_MAP);
/*     */     }
/*     */     catch (ScanException sce) {
/*  71 */       addError("Failed to parse pattern \"" + this.pattern + "\".", sce);
/*     */     }
/*     */   }
/*     */   
...
/* 115 */         DateTokenConverter<Object> dtc = (DateTokenConverter)p;
/*     */         
...
/* 217 */     while (p != null) {
/* 218 */       if ((p instanceof LiteralConverter)) {
...
/* 223 */         DateTokenConverter<Object> dtc = (DateTokenConverter)p;
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\rolling\helper\FileNamePattern.class
