...
/*  46 */     this.fileNamePattern = fileNamePattern;
/*  47 */     this.rc = rc;
/*  48 */     this.parentClean = computeParentCleaningFlag(fileNamePattern);
/*     */   }
/*     */   
/*  51 */   int callCount = 0;
/*     */   
...
/* 108 */           totalRemoved = (int)(totalRemoved + size);
/* 109 */           f.delete();
/*     */         }
/* 111 */         totalSize = (int)(totalSize + size);
/*     */       }
/*     */     }
...
/* 118 */     Arrays.sort(matchingFileArray, new Comparator()
/*     */     {
...
/*     */     
/* 172 */     while (p != null) {
/* 173 */       if ((p instanceof LiteralConverter)) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\rolling\helper\TimeBasedArchiveRemover.class
