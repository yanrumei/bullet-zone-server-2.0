...
/*  61 */       conditionAttribute = OptionHelper.substVars(conditionAttribute, ic, this.context);
...
/*     */     throws ActionException
/*     */   {
/*  80 */     IfState state = (IfState)this.stack.pop();
/*  81 */     if (!state.active) {
/*  82 */       return;
/*     */     }
/*     */     
...
/*     */   {
/* 118 */     IfState state = (IfState)this.stack.firstElement();
/* 119 */     if (state.active) {
...
/* 127 */     IfState state = (IfState)this.stack.firstElement();
/* 128 */     if (state.active) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\joran\conditional\IfAction.class
