...
/*    */ {
/*    */   URL mainURL;
/* 30 */   List<File> fileWatchList = new ArrayList();
/* 31 */   List<Long> lastModifiedList = new ArrayList();
/*    */   
...
/* 36 */     out.fileWatchList = new ArrayList(this.fileWatchList);
/* 37 */     out.lastModifiedList = new ArrayList(this.lastModifiedList);
/* 38 */     return out;
/*    */   }
/*    */   
/*    */   public void clear() {
...
/* 75 */     return new ArrayList(this.fileWatchList);
/*    */   }
/*    */   
...
/* 82 */       File file = (File)this.fileWatchList.get(i);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\joran\spi\ConfigurationWatchList.class
