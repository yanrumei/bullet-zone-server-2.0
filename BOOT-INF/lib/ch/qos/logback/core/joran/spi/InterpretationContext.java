...
/*  47 */   final List<InPlayListener> listenerList = new ArrayList();
...
/*  54 */     this.objectMap = new HashMap(5);
/*  55 */     this.propertiesMap = new HashMap(5);
/*     */   }
/*     */   
...
/*  63 */     return new HashMap(this.propertiesMap);
/*     */   }
/*     */   
...
/*     */   {
/* 145 */     String v = (String)this.propertiesMap.get(key);
/* 146 */     if (v != null) {
/* 147 */       return v;
/*     */     }
...
/* 155 */       return null;
/*     */     }
/* 157 */     return OptionHelper.substVars(value, this, this.context);
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\joran\spi\InterpretationContext.class
