...
/* 127 */       String l = (String)this.partList.get(i);
/* 128 */       String r = (String)p.partList.get(i);
/*     */       
/* 130 */       if (!equalityCheck(l, r)) break;
/* 131 */       match++;
/*     */     }
/*     */     
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\joran\spi\ElementSelector.class
