...
/*    */       
/* 52 */       this.appender = ((Appender)OptionHelper.instantiateByClassName(className, Appender.class, this.context));
/*    */       
...
/*    */ 
/*    */ 
/* 67 */       HashMap<String, Appender<E>> appenderBag = (HashMap)ec.getObjectMap().get("APPENDER_BAG");
/*    */       
/*    */ 
...
/*    */     }
/*    */     
/* 89 */     if ((this.appender instanceof LifeCycle)) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\joran\action\AppenderAction.class
