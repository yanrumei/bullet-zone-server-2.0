...
/*  70 */       addError("Error while parsing  " + this.attributeInUse, e);
/*     */     } finally {
/*  72 */       close(in);
/*     */     }
/*     */   }
...
/*     */     }
/*     */     
/* 203 */     SaxEvent first = (SaxEvent)saxEventList.get(0);
/* 204 */     if ((first != null) && (first.qName.equalsIgnoreCase("included"))) {
/* 205 */       saxEventList.remove(0);
/*     */     }
/*     */     
/* 208 */     SaxEvent last = (SaxEvent)saxEventList.get(recorder.saxEventList.size() - 1);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\joran\action\IncludeAction.class
