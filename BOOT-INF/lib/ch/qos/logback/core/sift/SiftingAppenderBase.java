...
/*  76 */       errors++;
/*     */     } else {
/*  78 */       this.appenderTracker = new AppenderTracker(this.context, this.appenderFactory);
...
/*     */   public void stop()
/*     */   {
/*  89 */     for (Appender<E> appender : this.appenderTracker.allComponents()) {
/*  90 */       appender.stop();
/*     */     }
/*     */   }
/*     */   
...
/*     */     
/* 104 */     Appender<E> appender = (Appender)this.appenderTracker.getOrCreate(discriminatingValue, timestamp);
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\sift\SiftingAppenderBase.class
