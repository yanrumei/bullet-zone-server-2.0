...
/*  52 */     this.ea = ((Object[])new Object[this.maxSize]);
...
/*  62 */     this.ea = ((Object[])new Object[maxSize]);
/*  63 */     this.first = 0;
/*  64 */     this.last = 0;
/*  65 */     this.numElems = 0;
/*     */   }
...
/*  97 */       return null;
/*     */     }
/*  99 */     return (E)this.ea[((this.first + i) % this.maxSize)];
/*     */   }
/*     */   
...
/*     */   {
/* 111 */     E r = null;
/* 112 */     if (this.numElems > 0) {
/* 113 */       this.numElems -= 1;
/* 114 */       r = this.ea[this.first];
/* 115 */       this.ea[this.first] = null;
/* 116 */       if (++this.first == this.maxSize)
/* 117 */         this.first = 0;
/*     */     }
/* 119 */     return r;
/*     */   }
...
/* 123 */     List<E> tList = new ArrayList();
...
/*     */     }
/*     */     
/* 153 */     E[] temp = (Object[])new Object[newSize];
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\helpers\CyclicBuffer.class
