...
/*  59 */     List<String> optionList = new ArrayList();
/*  60 */     char c = firstChar;
/*     */     
...
/* 104 */           this.state = 0;
/* 105 */         } else if (c == '\\') {
/* 106 */           escape(String.valueOf(this.quoteChar), buf);
/*     */         } else {
/* 108 */           buf.append(c);
/*     */         }
/*     */         
...
/* 115 */       this.tokenStream.pointer += 1;
/*     */     }
/*     */     
/*     */ 
/* 119 */     if (c == '}') {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-core-1.1.11.jar!\ch\qos\logback\core\pattern\parser\OptionTokenizer.class
