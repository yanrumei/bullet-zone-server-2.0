...
/* 131 */       StackTraceElementProxy[] arrayOfStackTraceElementProxy1; int j = (arrayOfStackTraceElementProxy1 = stepArray).length; for (int i = 0; i < j; i++) { StackTraceElementProxy step = arrayOfStackTraceElementProxy1[i];
/* 132 */         this.buf.append('\t');
...
/* 165 */         for (Object entry : entrySet) {
/* 166 */           this.buf.append("\r\n    <log4j:data");
/* 167 */           this.buf.append(" name='" + Transform.escapeTags((String)((Map.Entry)entry).getKey()) + "'");
/* 168 */           this.buf.append(" value='" + Transform.escapeTags((String)((Map.Entry)entry).getValue()) + "'");
/* 169 */           this.buf.append(" />");
/*     */         }
/* 171 */         this.buf.append("\r\n  </log4j:properties>");
/*     */       }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\log4j\XMLLayout.class
