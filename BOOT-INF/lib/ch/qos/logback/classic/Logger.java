...
/*     */ 
/*     */ 
/*  98 */   private transient boolean additive = true;
...
/* 135 */       Logger childLogger_i = (Logger)this.childrenList.get(i);
...
/* 167 */         Logger child = (Logger)this.childrenList.get(i);
/*     */         
...
/* 192 */           Logger child = (Logger)this.childrenList.get(i);
...
/* 308 */       this.childrenList = new CopyOnWriteArrayList();
/*     */     Logger childLogger;
/*     */     Logger childLogger;
/* 311 */     if (isRootLogger()) {
...
/* 355 */       this.childrenList = new CopyOnWriteArrayList();
/*     */     }
/*     */     
...
/*     */   {
/* 419 */     ch.qos.logback.classic.spi.LoggingEvent le = new ch.qos.logback.classic.spi.LoggingEvent(localFQCN, this, level, msg, t, params);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\Logger.class
