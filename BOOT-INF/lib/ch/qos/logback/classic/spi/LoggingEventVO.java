...
/* 185 */       this.argumentArray = new String[argArrayLen];
...
/* 201 */     result = 31 * result + (int)(this.timeStamp ^ this.timeStamp >>> 32);
/* 202 */     return result;
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\spi\LoggingEventVO.class
