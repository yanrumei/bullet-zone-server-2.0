...
/* 258 */       this.callerDataArray = 
/* 259 */         CallerData.extract(new Throwable(), this.fqnOfLoggerClass, this.loggerContext.getMaxCallerDataDepth(), this.loggerContext.getFrameworkPackages());
/*     */     }
...
/*     */     throws IOException
/*     */   {
/* 356 */     throw new UnsupportedOperationException(getClass() + " does not support serialization. " + 
/* 357 */       "Use LoggerEventVO instance instead. See also LoggerEventVO.build method.");
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\spi\LoggingEvent.class
