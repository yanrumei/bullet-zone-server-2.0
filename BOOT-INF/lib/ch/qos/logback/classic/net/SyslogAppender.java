...
/*  93 */         StackTraceElementProxy[] arrayOfStackTraceElementProxy1; int j = (arrayOfStackTraceElementProxy1 = stepArray).length; for (int i = 0; i < j; i++) { StackTraceElementProxy step = arrayOfStackTraceElementProxy1[i];
