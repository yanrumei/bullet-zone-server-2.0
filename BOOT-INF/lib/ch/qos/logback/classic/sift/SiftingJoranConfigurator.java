...
/* 45 */     rs.addRule(new ElementSelector("configuration/appender"), new AppenderAction());
/*    */   }
/*    */   
...
/* 57 */     omap.put("APPENDER_BAG", new HashMap());
/*    */     
/* 59 */     Map<String, String> propertiesMap = new HashMap();
...
/* 68 */     HashMap<String, Appender<?>> appenderMap = (HashMap)omap.get("APPENDER_BAG");
/* 69 */     oneAndOnlyOneCheck(appenderMap);
/* 70 */     Collection<Appender<?>> values = appenderMap.values();
/* 71 */     if (values.size() == 0) {
/* 72 */       return null;
/*    */     }
/* 74 */     return (Appender)values.iterator().next();
/*    */   }
/*    */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\sift\SiftingJoranConfigurator.class
