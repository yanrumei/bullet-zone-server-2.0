...
/*  75 */         Map<String, EventEvaluator<?>> evaluatorMap = (Map)context.getObject("EVALUATOR_MAP");
...
/*  89 */       this.evaluatorList = new ArrayList();
/*     */     }
...
/*  96 */       this.ignoredStackTraceLines = new ArrayList();
/*     */     }
...
/* 133 */             errorStatus.add(new ErrorStatus("This was the last warning about this evaluator's errors.We don't want the StatusManager to get flooded.", 
/* 134 */               this));
...
/*     */     
/* 151 */     recursiveAppend(sb, null, 1, tp);
/*     */     
...
/* 163 */     if (suppressed != null) { IThrowableProxy[] arrayOfIThrowableProxy1;
/* 164 */       int j = (arrayOfIThrowableProxy1 = suppressed).length; for (int i = 0; i < j; i++) { IThrowableProxy current = arrayOfIThrowableProxy1[i];
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\pattern\ThrowableProxyConverter.class
