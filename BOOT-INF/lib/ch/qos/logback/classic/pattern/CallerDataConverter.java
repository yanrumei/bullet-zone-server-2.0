...
/*  76 */         String evaluatorStr = (String)optionList.get(i);
/*  77 */         Context context = getContext();
/*  78 */         if (context != null) {
/*  79 */           Map<String, EventEvaluator<?>> evaluatorMap = (Map)context.getObject("EVALUATOR_MAP");
/*  80 */           EventEvaluator<ILoggingEvent> ee = (EventEvaluator)evaluatorMap.get(evaluatorStr);
/*  81 */           if (ee != null) {
/*  82 */             addEvaluator(ee);
/*     */           }
/*     */         }
...
/* 107 */       this.evaluatorList = new ArrayList();
/*     */     }
...
/* 118 */         EventEvaluator<ILoggingEvent> ee = (EventEvaluator)this.evaluatorList.get(i);
/*     */         try {
...
/* 130 */             errorStatus.add(new ErrorStatus("This was the last warning about this evaluator's errors.We don't want the StatusManager to get flooded.", 
/* 131 */               this));
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classic\pattern\CallerDataConverter.class
