...
/*     */ {
/*  55 */   final ThreadLocal<Map<String, String>> copyOnThreadLocal = new ThreadLocal();
/*     */   
/*     */   private static final int WRITE_OPERATION = 1;
/*     */   
/*     */   private static final int MAP_COPY_OPERATION = 2;
/*     */   
/*  61 */   final ThreadLocal<Integer> lastOperation = new ThreadLocal();
/*     */   
/*     */   private Integer getAndSetLastOperation(int op) {
/*  64 */     Integer lastOp = (Integer)this.lastOperation.get();
...
/*  74 */     Map<String, String> newMap = Collections.synchronizedMap(new HashMap());
/*  75 */     if (oldMap != null)
/*     */     {
/*     */ 
...
/*     */     }
/*     */     
/* 103 */     Map<String, String> oldMap = (Map)this.copyOnThreadLocal.get();
...
/* 120 */       return;
/*     */     }
/* 122 */     Map<String, String> oldMap = (Map)this.copyOnThreadLocal.get();
/* 123 */     if (oldMap == null) {
/* 124 */       return;
/*     */     }
...
/*     */   {
/* 149 */     Map<String, String> map = (Map)this.copyOnThreadLocal.get();
/* 150 */     if ((map != null) && (key != null)) {
/* 151 */       return (String)map.get(key);
/*     */     }
/* 153 */     return null;
/*     */   }
/*     */   
...
/* 163 */     return (Map)this.copyOnThreadLocal.get();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 185 */     Map<String, String> hashMap = (Map)this.copyOnThreadLocal.get();
/* 186 */     if (hashMap == null) {
/* 187 */       return null;
/*     */     }
...
/*     */     
/* 196 */     Map<String, String> newMap = Collections.synchronizedMap(new HashMap());
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classi\\util\LogbackMDCAdapter.class
