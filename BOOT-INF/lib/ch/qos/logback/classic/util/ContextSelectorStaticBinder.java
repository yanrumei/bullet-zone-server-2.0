...
/* 64 */       this.contextSelector = new DefaultContextSelector(defaultLoggerContext);
/* 65 */     } else if (contextSelectorStr.equals("JNDI"))
/*    */     {
/* 67 */       this.contextSelector = new ContextJNDISelector(defaultLoggerContext);
/*    */     } else {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\logback-classic-1.1.11.jar!\ch\qos\logback\classi\\util\ContextSelectorStaticBinder.class
