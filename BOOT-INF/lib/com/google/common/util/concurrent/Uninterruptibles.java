...
/*     */     try
/*     */     {
/* 142 */       return (V)future.get();
/*     */     } catch (InterruptedException e) {
/* 144 */       for (;;) { interrupted = true;
/*     */       }
/*     */     }
/*     */     finally {
/* 148 */       if (interrupted) {
...
/*     */     try
/*     */     {
/* 233 */       return (E)queue.take();
/*     */     } catch (InterruptedException e) {
/* 235 */       for (;;) { interrupted = true;
/*     */       }
/*     */     }
/*     */     finally {
/* 239 */       if (interrupted) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\commo\\util\concurrent\Uninterruptibles.class
