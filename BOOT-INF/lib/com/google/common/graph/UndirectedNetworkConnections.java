...
/* 42 */     return new UndirectedNetworkConnections(HashBiMap.create(2));
/*    */   }
/*    */   
/*    */   static <N, E> UndirectedNetworkConnections<N, E> ofImmutable(Map<E, N> incidentEdges) {
/* 46 */     return new UndirectedNetworkConnections(ImmutableBiMap.copyOf(incidentEdges));
/*    */   }
/*    */   
...
/*    */   {
/* 56 */     return new EdgesConnecting(((BiMap)this.incidentEdgeMap).inverse(), node);
/*    */   }
/*    */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\graph\UndirectedNetworkConnections.class
