...
/*  37 */   protected Iterator<N> successorIterator = ImmutableSet.of().iterator();
/*     */   
/*     */   static <N> EndpointPairIterator<N> of(BaseGraph<N> graph) {
/*  40 */     return graph.isDirected() ? new Directed(graph, null) : new Undirected(graph, null);
/*     */   }
/*     */   
...
/*     */         }
/*  77 */       } while (advance());
/*  78 */       return (EndpointPair)endOfData();
/*     */     }
/*     */   }
/*     */   
/*     */ 
...
/* 131 */       return (EndpointPair)endOfData();
/*     */     }
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\graph\EndpointPairIterator.class
