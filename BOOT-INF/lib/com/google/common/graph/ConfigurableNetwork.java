...
/*     */     
/*  68 */       .createMap(
/*  69 */       ((Integer)builder.expectedNodeCount.or(Integer.valueOf(10))).intValue()), builder.edgeOrder
...
/*     */     
/*     */ 
/*  88 */     this.nodeConnections = ((nodeConnections instanceof TreeMap) ? new MapRetrievalCache(nodeConnections) : new MapIteratorCache(nodeConnections));
/*     */     
/*     */ 
/*     */ 
...
/* 138 */     N nodeV = ((NetworkConnections)this.nodeConnections.get(nodeU)).oppositeNode(edge);
...
/* 178 */     NetworkConnections<N, E> connections = (NetworkConnections)this.nodeConnections.get(node);
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\graph\ConfigurableNetwork.class
