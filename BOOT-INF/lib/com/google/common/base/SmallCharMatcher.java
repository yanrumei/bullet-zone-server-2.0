...
/*  93 */     int mask = table.length - 1;
/*  94 */     for (int c = chars.nextSetBit(0); c != -1; c = chars.nextSetBit(c + 1))
/*     */     {
/*  96 */       filter |= 1L << c;
/*  97 */       int index = smear(c) & mask;
/*     */       for (;;)
/*     */       {
/* 100 */         if (table[index] == 0) {
/* 101 */           table[index] = ((char)c);
/* 102 */           break;
/*     */         }
/*     */         
/* 105 */         index = index + 1 & mask;
/*     */       }
/*     */     }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\base\SmallCharMatcher.class
