...
/* 157 */             return false;
/*     */           }
/* 159 */         } else if (byte1 < -16)
/*     */         {
/* 161 */           if (index + 1 >= end) {
/* 162 */             return false;
/*     */           }
/* 164 */           int byte2 = bytes[(index++)];
/* 165 */           if ((byte2 > -65) || ((byte1 == -32) && (byte2 < -96)) || ((byte1 == -19) && (-96 <= byte2)) || (bytes[(index++)] > -65))
/*     */           {
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\base\Utf8.class
