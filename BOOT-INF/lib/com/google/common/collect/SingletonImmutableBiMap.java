...
/*     */   {
/*  55 */     return (V)(this.singleKey.equals(key) ? this.singleValue : null);
/*     */   }
/*     */   
/*     */   public int size()
/*     */   {
...
/*     */   {
/*  65 */     ((BiConsumer)Preconditions.checkNotNull(action)).accept(this.singleKey, this.singleValue);
/*     */   }
/*     */   
...
/* 101 */     if (result == null) {
/* 102 */       return this.inverse = new SingletonImmutableBiMap(this.singleValue, this.singleKey, this);
/*     */     }
/* 104 */     return result;
/*     */   }
/*     */ }
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\collect\SingletonImmutableBiMap.class
