...
/*     */   {
/*  85 */     return new TopKSelector(comparator, k);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/*  95 */     return new TopKSelector(Ordering.from(comparator).reverse(), k);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 116 */     this.comparator = ((Comparator)Preconditions.checkNotNull(comparator, "comparator"));
/* 117 */     this.k = k;
/* 118 */     Preconditions.checkArgument(k >= 0, "k must be nonnegative, was %s", k);
/* 119 */     this.buffer = ((Object[])new Object[k * 2]);
...
/* 170 */       } else { if (pivotNewIndex >= this.k) break;
...
/*     */   public List<T> topK()
/*     */   {
/* 264 */     Arrays.sort(this.buffer, 0, this.bufferSize, this.comparator);
/* 265 */     if (this.bufferSize > this.k) {
/* 266 */       Arrays.fill(this.buffer, this.k, this.buffer.length, null);
/* 267 */       this.bufferSize = this.k;
/* 268 */       this.threshold = this.buffer[(this.k - 1)];
/*     */     }
/*     */     
/* 271 */     return Collections.unmodifiableList(Arrays.asList(Arrays.copyOf(this.buffer, this.bufferSize)));
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\collect\TopKSelector.class
