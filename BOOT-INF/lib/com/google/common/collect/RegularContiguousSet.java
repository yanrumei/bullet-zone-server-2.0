...
/*  45 */       ContiguousSet.create(this.range.intersection(other), this.domain) : new EmptyContiguousSet(this.domain);
/*     */   }
/*     */   
/*     */ 
...
/*  62 */       Range.range(fromElement, 
/*  63 */       BoundType.forBoolean(fromInclusive), toElement, 
/*  64 */       BoundType.forBoolean(toInclusive)));
/*     */   }
/*     */   
/*     */   ContiguousSet<C> tailSetImpl(C fromElement, boolean inclusive)
/*     */   {
/*  69 */     return intersectionInCurrentDomain(Range.downTo(fromElement, BoundType.forBoolean(inclusive)));
/*     */   }
/*     */   
/*     */   @GwtIncompatible
/*     */   int indexOf(Object target)
/*     */   {
/*  75 */     return contains(target) ? (int)this.domain.distance(first(), (Comparable)target) : -1;
/*     */   }
/*     */   
/*     */   public UnmodifiableIterator<C> iterator()
/*     */   {
/*  80 */     new AbstractSequentialIterator(first()) {
/*  81 */       final C last = RegularContiguousSet.this.last();
/*     */       
/*     */       protected C computeNext(C previous)
/*     */       {
/*  85 */         return RegularContiguousSet.equalsOrThrow(previous, this.last) ? null : RegularContiguousSet.this.domain.next(previous);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*     */   {
/*  93 */     new AbstractSequentialIterator(last()) {
/*  94 */       final C first = RegularContiguousSet.this.first();
/*     */       
/*     */       protected C computeNext(C previous)
/*     */       {
/*  98 */         return RegularContiguousSet.equalsOrThrow(previous, this.first) ? null : RegularContiguousSet.this.domain.previous(previous);
/*     */       }
/*     */     };
/*     */   }
/*     */   
...
/*     */     }
/*     */     try {
/* 154 */       return this.range.contains((Comparable)object);
...
/* 175 */       return other;
/*     */     }
/* 177 */     C lowerEndpoint = (Comparable)Ordering.natural().max(first(), other.first());
/* 178 */     C upperEndpoint = (Comparable)Ordering.natural().min(last(), other.last());
/* 179 */     return lowerEndpoint.compareTo(upperEndpoint) <= 0 ? 
/* 180 */       ContiguousSet.create(Range.closed(lowerEndpoint, upperEndpoint), this.domain) : new EmptyContiguousSet(this.domain);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 192 */     return Range.create(this.range.lowerBound
...
/*     */   Object writeReplace()
/*     */   {
/* 234 */     return new SerializedForm(this.range, this.domain, null);
/*     */   }
/*     */ }


/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\guava-22.0.jar!\com\google\common\collect\RegularContiguousSet.class
