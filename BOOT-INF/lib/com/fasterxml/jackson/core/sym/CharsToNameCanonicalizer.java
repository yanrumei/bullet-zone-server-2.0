...
/*     */     
/* 243 */     this._tableInfo = new AtomicReference(TableInfo.createInitial(64));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   }
/*     */   
/* 276 */   private static int _thresholdSize(int hashAreaSize) { return hashAreaSize - (hashAreaSize >> 2); }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*     */   {
/* 315 */     return new CharsToNameCanonicalizer(this, flags, this._seed, (TableInfo)this._tableInfo.get());
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* 347 */     TableInfo currState = (TableInfo)this._tableInfo.get();
/*     */     
/*     */ 
/*     */ 
...
/*     */ 
/*     */ 
/* 385 */   public int bucketCount() { return this._symbols.length; }
/* 386 */   public boolean maybeDirty() { return !this._hashShared; }
/* 387 */   public int hashSeed() { return this._seed; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 563 */     int i = start; for (int end = start + len; i < end; i++) {
...
/* 594 */     this._symbols = ((String[])Arrays.copyOf(oldSyms, oldSyms.length));
/* 595 */     Bucket[] oldBuckets = this._buckets;
/* 596 */     this._buckets = ((Bucket[])Arrays.copyOf(oldBuckets, oldBuckets.length));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jackson-core-2.8.10.jar!\com\fasterxml\jackson\core\sym\CharsToNameCanonicalizer.class
