...
/*  36 */       num = num * 10 + (ch[(++off)] - '0');
/*  37 */       len -= 4;
/*  38 */       if (len > 4) {
/*  39 */         num = num * 10 + (ch[(++off)] - '0');
/*  40 */         num = num * 10 + (ch[(++off)] - '0');
/*  41 */         num = num * 10 + (ch[(++off)] - '0');
/*  42 */         num = num * 10 + (ch[(++off)] - '0');
/*  43 */         return num;
/*     */       }
/*     */     }
/*  46 */     if (len > 1) {
/*  47 */       num = num * 10 + (ch[(++off)] - '0');
/*  48 */       if (len > 2) {
/*  49 */         num = num * 10 + (ch[(++off)] - '0');
/*  50 */         if (len > 3) {
/*  51 */           num = num * 10 + (ch[(++off)] - '0');
/*     */         }
/*     */       }
/*     */     }
/*  55 */     return num;
...
/* 289 */     try { return new BigDecimal(s);
/* 290 */     } catch (NumberFormatException e) { throw _badBD(s);
/*     */     }
/*     */   }
/*     */   
/*     */ 
/* 295 */   public static BigDecimal parseBigDecimal(char[] b) throws NumberFormatException { return parseBigDecimal(b, 0, b.length); }
/*     */   
...
/* 300 */     } catch (NumberFormatException e) { throw _badBD(new String(b, off, len));
/*     */     }
/*     */   }
/*     */   
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jackson-core-2.8.10.jar!\com\fasterxml\jackson\core\io\NumberInput.class
