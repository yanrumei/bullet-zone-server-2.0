...
/* 140 */       int ptr = this._ptr;
/*     */       int lo;
/*     */       int lo;
/* 143 */       int hi; if (this._bigEndian) {
/* 144 */         int hi = this._buffer[ptr] << 8 | this._buffer[(ptr + 1)] & 0xFF;
...
/*     */     throws IOException
/*     */   {
/* 187 */     int bytePos = this._byteCount + gotBytes;int charPos = this._charCount;
/*     */     
...
/* 193 */     int bytePos = this._byteCount + this._ptr - 1;int charPos = this._charCount + offset;
/*     */     
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jackson-core-2.8.10.jar!\com\fasterxml\jackson\core\io\UTF32Reader.class
