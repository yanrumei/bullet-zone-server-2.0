...
/*     */ 
/*     */ 
/* 191 */   public String getName() { return this._name; }
/*     */   
...
/* 196 */   public char getPaddingChar() { return this._paddingChar; }
/* 197 */   public byte getPaddingByte() { return (byte)this._paddingChar; }
/*     */   
/* 199 */   public int getMaxLineLength() { return this._maxLineLength; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 401 */       chunksBeforeLF--; if (chunksBeforeLF <= 0)
/*     */       {
/* 403 */         sb.append('\\');
/* 404 */         sb.append('n');
...
/*     */ 
/* 575 */     if (ch <= ' ') {
/* 576 */       base = "Illegal white space character (code 0x" + Integer.toHexString(ch) + ") as character #" + (bindex + 1) + " of 4-char base64 unit: can only used between units"; } else { String base;
/* 577 */       if (usesPaddingChar(ch)) {
/* 578 */         base = "Unexpected padding character ('" + getPaddingChar() + "') as character #" + (bindex + 1) + " of 4-char base64 unit: padding only legal as 3rd or 4th character"; } else { String base;
/* 579 */         if ((!Character.isDefined(ch)) || (Character.isISOControl(ch)))
/*     */         {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jackson-core-2.8.10.jar!\com\fasterxml\jackson\core\Base64Variant.class
