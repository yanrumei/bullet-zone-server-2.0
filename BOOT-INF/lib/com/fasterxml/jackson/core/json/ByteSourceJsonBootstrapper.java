...
/* 166 */         break;
/* 167 */       case 2:  enc = this._bigEndian ? JsonEncoding.UTF16_BE : JsonEncoding.UTF16_LE;
/* 168 */         break;
/* 169 */       case 4:  enc = this._bigEndian ? JsonEncoding.UTF32_BE : JsonEncoding.UTF32_LE;
/* 170 */         break;
/* 171 */       case 3: default:  throw new RuntimeException("Internal error");
/*     */       }
/*     */     }
...
/* 230 */         in = new MergedStream(this._context, in, this._inputBuffer, this._inputPtr, this._inputEnd);
/*     */       }
/*     */       
/* 233 */       return new InputStreamReader(in, enc.getJavaName());
/*     */     
/*     */     case 32: 
/* 236 */       return new UTF32Reader(this._context, this._in, this._inputBuffer, this._inputPtr, this._inputEnd, this._context.getEncoding().isBigEndian());
/*     */     }
/*     */     
...
/* 254 */         return new UTF8StreamJsonParser(this._context, parserFeatures, this._in, codec, can, this._inputBuffer, this._inputPtr, this._inputEnd, this._bufferRecyclable);
/*     */       }
/*     */     }
/*     */     
/* 258 */     return new ReaderBasedJsonParser(this._context, parserFeatures, constructReader(), codec, rootCharSymbols.makeChild(factoryFeatures));
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     throws IOException
/*     */   {
/* 366 */     int i = 0; for (int len = matchStr.length(); i < len; i++) {
...
/* Location:              C:\Users\ikatwal\Downloads\bullet-zone-server-2.0.jar!\BOOT-INF\lib\jackson-core-2.8.10.jar!\com\fasterxml\jackson\core\json\ByteSourceJsonBootstrapper.class
